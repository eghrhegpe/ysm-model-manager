...
- **类型**：项目评估 / 技术债盘点
- **相关**：architecture.md / logic-sinking.md / app_*.go / frontend/js / scripts/ / tests/python/
...
| 🔴 RED | `frontend/js/components/app-content/community/site-view.js` | **1,268** | 社区站点视图，未按规范拆分 |
| 🟡 YELLOW | `frontend/js/components/app-content/index.js` | 921 | 入口聚合，可接受 |
| 🟡 YELLOW | `frontend/js/components/app-content/content-css.js` | 919 | Shadow DOM 样式，免拆 |
| 🟡 YELLOW | `frontend/js/features/import-queue.js` | 835 | 业务逻辑与 UI 渲染混合 |
| 🟡 YELLOW | `frontend/js/components/app-content/community/settings.js` | 733 | 社区设置页 |
...
- `frontend/js/components/app-content/community/site-view.js` → 拆分为多文件
