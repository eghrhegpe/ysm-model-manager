...
- **相关**：`frontend/js/core/context-menus.js` / `frontend/js/views/context-menu.js` / `frontend/js/app-modules.js`
...
| `frontend/js/views/context-menu.js` | 134 行，Web Component 渲染器 |
| `frontend/js/views/app-sidebar/events.js` | 防重复绑定逻辑 |
