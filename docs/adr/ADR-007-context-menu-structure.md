...
| 来源 | 结果 |
|------|------|
| `frontend/src/core/context-menus.js` | 513 行，包含 3 个 type 分支的完整菜单定义 |
| `frontend/src/views/context-menu.js` | 134 行，Web Component 渲染器 |
| `frontend/src/views/app-sidebar/events.js` | 防重复绑定逻辑 |
