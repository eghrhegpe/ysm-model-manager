...
- **相关**：`frontend/js/core/context-menus.js` / `frontend/js/views/app-tree/bus-handlers.js` / `frontend/js/features/import-queue.js` / `frontend/js/views/app-content/community/settings.js`
