...
| ADR-023 | 测试体系 | 🔄 部分采纳（Go 单测 + Node 契约测试现行；Vitest 前端单测评估中） | 2026-08-03 |
<!-- /GEN: adr-registry -->
...
<!-- GEN: adr-stats -->
- ✅ 已采纳：13 篇（ADR-001 / ADR-002 / ADR-004 / ADR-005 / ADR-006 / ADR-007 / ADR-008 / ADR-013 / ADR-014 / ADR-015 / ADR-018 / ADR-019 / ADR-020）
