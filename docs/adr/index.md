...
> 架构决策日志，共 **295** 篇。决策真相源 = 各 ADR 文件首部「状态」行；本页为登记表 + 规范索引（单文件承载全部）。
...
| ADR | 标题 | 状态 |
|-----|------|------|
| [ADR-297](./ADR-297-water-planar-reflection.md) | 水面模型倒影：隐藏 Reflector 借官方 RT + 水 shader 投影采样 | 📝 提议中 |
...
| 编号 | 标题 | 状态 | 日期 |
|------|------|------|------|
| ADR-297 | 水面模型倒影：隐藏 Reflector 借官方 RT + 水 shader 投影采样 | 📝 提议中 | 2026-09-22 |
