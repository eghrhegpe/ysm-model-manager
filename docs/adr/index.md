...
> 架构决策日志，共 **224** 篇。决策真相源 = 各 ADR 文件首部「状态」行；本页为登记表 + 规范索引（单文件承载全部）。
...
| [ADR-225](./ADR-225-perception-adapters-shared.md) | perception 模块下沉至 adapters/shared | 🔄 部分采纳 |
...
| ADR-225 | perception 模块下沉至 adapters/shared | 🔄 部分采纳 | 2026-09-11 |
