...
> 架构决策日志，共 **303** 篇。决策真相源 = 各 ADR 文件首部「状态」行；本页为登记表 + 规范索引（单文件承载全部）。
...
| ADR | 标题 | 状态 |
|-----|------|------|
| [ADR-305](./ADR-305-menu-naming-decoupling-contract.md) | preview-3D 菜单命名脱钩裁定：三命名族稳定契约 | 📝 提议中 |
...
| 编号 | 标题 | 状态 | 日期 |
|------|------|------|------|
| ADR-305 | preview-3D 菜单命名脱钩裁定：三命名族稳定契约 | 📝 提议中 | 2026-09-24 |
