...
| `frontend/src/features/preview-3d/model3d.ts` | Three.js 3D 渲染：场景/相机/灯光/网格 | ~464 |
| `frontend/src/features/preview-3d/model3d-spec.ts` | JS 兜底 Spec 构建（Go 不可用时） | ~255 |
| `frontend/src/features/preview-3d/model2d.ts` | Canvas 2D 骨骼图：正交投影、旋转、热区 | ~556 |
...
2. frontend/src/features/preview-3d/model3d-spec.ts 全文
3. frontend/src/features/preview-3d/model2d.ts 全文
...
3. frontend/src/features/preview-3d/model3d.ts
4. frontend/src/features/preview-3d/model2d.ts
...
| DeepSeek V4 Flash | JS 兜底 `model3d-spec.js` 同步 | `frontend/src/features/preview-3d/model3d-spec.ts` |
| Qwen3.7 Plus | 2D 骨骼图修正 | `frontend/src/features/preview-3d/model2d.ts` |
...
| `frontend/src/features/preview-3d/model3d-spec.ts` | `buildSpecFromModel()` :8 | JS 兜底，必须与 Go 一致 |
| `frontend/src/features/preview-3d/model2d.ts` | `renderModel2D()` :15 | 2D 正交投影 |
| `frontend/src/features/preview-3d/model2d.ts` | `rot()` :64 | Y 轴旋转函数 |
| `frontend/src/features/preview-3d/model3d.ts` | `renderModel3D()` :36 | Three.js 场景构建 |
