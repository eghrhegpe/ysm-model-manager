...
| 函数 | 文件 | 行 |
|------|------|----|
| connectedCallback | `frontend/src/views/app-preview/index.ts` | 162 |
...
| _showModelDetail | `frontend/src/views/app-preview/index.ts` | 297 |
| _showModelDetail | `frontend/src/views/app-preview/index.ts` | 321 |
