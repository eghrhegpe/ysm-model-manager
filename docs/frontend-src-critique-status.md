...
- 待处置：S2 对账 fixtures 基建（ADR-174 D5 收口定义）/ G6 / P1（排期）、P2 / P4（评估留档，不铺开）；P3 仅剩「届期清退」动作挂在 2027-06-30
