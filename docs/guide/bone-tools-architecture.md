...
> 本文档沉淀 YSM 项目中 `preview-3d/bone-tools.ts` 的架构设计经验，供其他 3D 项目参考。
...
- `frontend/src/preview-3d/bone-tools.ts` — 通用工具实现
- `frontend/src/preview-3d/adapters/vrm-bone.ts` — VRM 适配
- `frontend/src/preview-3d/mmd-bones.ts` — MMD 适配
- `frontend/src/preview-3d/bone-tools.test.ts` — 通用层测试
- `frontend/src/preview-3d/adapters/vrm-bone.test.ts` — 适配层测试
