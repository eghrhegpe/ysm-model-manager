...
- **ground-cap-materialgroup-factories**（ground-cap 材质菜单工厂（material-group factories））：`ground-capability.ts` `buildGroundMaterialGroup` 148 行（L541-688；T2 工厂化曾从 133 行降至 ~55 行，2026-08-28 拓展后回升至 148 行），构建「表面材质…
