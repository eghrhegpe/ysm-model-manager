...
| 🍃 survey_emoji_icons | emoji/UI_ICONS 摸排方法论 | leaf | — | — |
...
- **app_content_diagnostics**（诊断与冲突页 diagnostics）：`diagnostics/` 是 `app-content` 的「诊断与冲突」页子域，顶部 **6 个** `repo-tab`（log / bench / record / conflict / health / sync-conflic…
