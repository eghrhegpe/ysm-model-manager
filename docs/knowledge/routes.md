...
| 诊断页、冲突、去重流程、诊断页日志 tab、性能、oldest | [诊断与冲突页 diagnostics](./app_content_diagnostics.md) | `diagnostics/` 是 `app-content` 的「诊断与冲突」页子域，顶部 8 个 `repo-tab`（log / single / gui / hist / trace / conflict / health / syn… |
