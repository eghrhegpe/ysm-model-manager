...
| pre-commit、钩子、文档同步、自动 stage、并发隔离、逃生留痕 | [提交前钩子 pre-commit](./pre-commit-hook.md) | `.githooks/pre-commit`（非阻断）在 commit 前跑秒级 gen 脚本同步文档/索引/知识卡机器生成区，并**仅 stage 本次 gen 实际 touch 的文件**（gen 前后快照 diff 对比，2026-0… |
