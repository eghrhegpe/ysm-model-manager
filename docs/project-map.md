...
| `preview-3d/` | 3D 预览领域根（ADR-129 升格、ADR-138 上提）：menu/adapters/caps/state/perception/decoder/vendor + 骨骼/材质/贴图/渲染工具族 〔源码 46 · 测试 37 · 子目录 7: adapters/ caps/ decoder/ menu/ perception/ state/ vendor/〕 |
