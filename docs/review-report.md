...
| 🟢 低 P4 | [wasm-decode.ts#L110-L127](../frontend/src/preview-3d/decoder/wasm-decode.ts#L110-L127) | 同文件已有 `devLog`，却残留 3 处裸 `console.log`（生产环境仍输出） | 换 `devLog` 或删除（按约定需先请示） |
