...
.cr-avatar-ring { position:absolute;inset:-2px;border-radius:50%;pointer-events:none;transition:transform .3s ease;z-index:2; }
.cr-avatar-ring[data-spin]:hover { animation:ring-spin .5s linear infinite; }
...
.gh-card:hover .cr-avatar { transform:rotate(-8deg) scale(1.1); }
.gh-card:hover .cr-avatar-ring { transform:scale(1.1); }
.gh-card:hover .cr-avatar-ring[data-spin] { transform:scale(1.1); }
.gh-card.active .cr-avatar { transform:rotate(-8deg) scale(1.12); }
.gh-card.active .cr-avatar-ring { transform:scale(1.12); }
