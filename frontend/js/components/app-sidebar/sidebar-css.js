...
.tag { font-size: var(--fs-sm); padding: 1px 5px; border-radius: 3px; }
...
.footer-stats { display: flex; flex-direction: column; gap: 2px; font-size: var(--fs-base); color: var(--muted); margin-bottom: 6px; }
.footer-btn {
  width: 100%; padding: 5px 8px; border-radius: 6px;
  border: 1px solid var(--bd); background: transparent;
  color: var(--txt); cursor: pointer; font-size: var(--fs-base); font-family: var(--font-ui);
