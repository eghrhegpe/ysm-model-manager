...
export const ja: Record<string, string> = {
  "hub.browseByAuthor": "作者別に表示",
  "hub.authorCategories": "作者カテゴリ",
  "settings.storage.ysmPath": "YSM モデル保存パス",
  "settings.storage.ysmPathDesc": "ランチャーのバージョンを選ぶと、モデルは config/yes_steve_model/custom に直接保存されます",
