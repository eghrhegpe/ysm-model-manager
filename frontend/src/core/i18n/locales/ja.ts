...
export const ja: Record<string, string> = {
  ...
  "settings.launcher.detect": "🎮 HMCL / PCL を検出",
  "settings.launcher.title": "ランチャーのインスタンスを選択",
  "settings.launcher.desc": "ランチャー、Minecraft バージョン、実際のゲームディレクトリ、YSM モデルディレクトリを解析しました。",
  "settings.launcher.gameDir": "ゲームディレクトリ",
