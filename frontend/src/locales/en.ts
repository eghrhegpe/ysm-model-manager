...
export const en: Record<string, string> = {
  ...
  "settings.defaultPage.remember": "Resume last visited",
  ...
  "settings.defaultPageHint":
    "When checked, the app remembers and restores your last visited page. Uncheck to always open the page selected below (no memory).",
