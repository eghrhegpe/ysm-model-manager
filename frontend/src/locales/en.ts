...
export const en: Record<string, string> = {
  ...
  "workshop.rateLimited": "⏱️ GitHub API rate limit reached, please retry later",
  ...
  "workshop.rateLimitedGithub": "⏱️ GitHub API rate limit reached, retry later or open in browser",
