...
export const ja: Record<string, string> = {
  ...
  "preview.spotlightHint": "上方から投げる円錐状の光",
  "preview.spotlightIntensity": "スポット強度",
  "preview.spotlightIntensityHint": "目標到達照度 (lx)・距離減衰から分離",
  "preview.spotlightVolume": "スポットライトと体積光",
  "preview.keyAzimuth": "キーライト方位角",
  "preview.keyElevation": "キーライト仰角",
  "preview.keyIntensity": "キーライト強度",
  "preview.keyColor": "キーライト色",
  "preview.fillAzimuth": "フィル方位角",
  "preview.fillElevation": "フィル仰角",
  "preview.fillIntensity": "フィル強度",
  "preview.rimAzimuth": "リム方位角",
  "preview.rimElevation": "リム仰角",
  "preview.rimIntensity": "リム強度",
