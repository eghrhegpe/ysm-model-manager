...
export const ja: Record<string, string> = {
  ...
  "settings.keymap.conflict": "⚠️ {key} は「{label}」によって使用されています",
  "settings.keymap.bound": "✅ {label} → {key}",
  "settings.keymap.resetDone": "↩️ デフォルトのキー設定に戻しました",
  ...
  "workshop.rateLimited": "⏱️ GitHub API レート制限です。後で再試行してください",
