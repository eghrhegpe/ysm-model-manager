...
export const zhCN = {
  ...
  "diagnostics.loadResourceTypesFailed": "加载资源类型失败",
  ...
  "syncManager.loadTypeConfigFailed": "资源类型配置加载失败",
  ...
  "preview.morphApplySent": "已发送应用请求：{name}",
  "preview.stageLoadSent": "已发送舞台加载请求：{name}",
