...
// 2026-09 自 core/i18n/locales 外移至此（core 瘦身，ADR-186）。
...
export const zhCN = {
  ...
  "advFilter.validation.minGtMaxBones": "骨骼数：最小值不能大于最大值",
  ...
  "settings.mirror.nameDirect": "直连",
  "settings.mirror.nameJsdelivr": "jsDelivr CDN",
  "settings.mirror.nameGithubapi": "GitHub API",
  "settings.setGameRootFirst": "请先设置游戏根目录",
  "settings.relinkFailed": "{failed} 个整合包重新链接失败",
  ...
  "settings.keymap.bindingAria": "{label}；快捷键 {key}",
  "settings.keymap.captureAria": "{label}：正在等待按键；Esc 取消",
  "settings.keymap.conflict": "{key} 已被「{label}」占用",
  "settings.keymap.bound": "{label} → {key}",
  "settings.keymap.resetDone": "已恢复默认键位",
  "settings.keymap.keySpace": "空格",
  "settings.keymap.keyShiftRight": "Shift(右)",
  "settings.keymap.keyControlRight": "Ctrl(右)",
  "settings.keymap.keyAltRight": "Alt(右)",
  "settings.keymap.actionForward": "前移",
  "settings.keymap.actionBack": "后移",
  "settings.keymap.actionLeft": "左移",
  "settings.keymap.actionRight": "右移",
  "settings.keymap.actionUp": "上升",
  ...
  "settings.ui.defaultPageSaved": "固定页面已保存",
  "settings.ui.rememberPageOn": "已改为跟随上次访问",
  "settings.ui.rememberPageOff": "已固定启动页面",
  "settings.worker.fbxOn": "FBX worker 已开启",
  "settings.worker.fbxOff": "FBX worker 已关闭",
  "settings.worker.mmdOn": "MMD PMX worker 已开启",
  "settings.worker.mmdOff": "MMD PMX worker 已关闭",
  ...
  "settings.preview3d.keymap": "操作键位（点击后按一个键重绑）",
  "settings.preview3d.keymapHint":
    "点击键位后按一个键；Esc 取消。方向键始终可用作移动兜底；修改即时生效，下次 3D 预览启用。",
  ...
  // 子 pill 行的 aria-label（renderSubBar 必传，读屏念它——硬编码英文等于中文用户听天书）
  "diagnostics.subBarLogs": "日志子屏",
  "diagnostics.subBarBench": "基准模式",
  "diagnostics.subBarAudit": "体检项目",
  ...
  "diagnostics.perfModelUnreadHint":
    "填路径只对「单模型」这一目标集有效；选类型 / 全部 / 全库时不需要路径",
  "diagnostics.webNoSyncConflictScan": "网页版不支持同步冲突扫描",
  "diagnostics.loadDedupConfigFailed": "加载去重配置失败",
  "diagnostics.webNoClearLogs": "网页版不支持清除日志",
  "diagnostics.noLogsToCopy": "当前无日志可复制",
  "diagnostics.perfCopied": "已复制原始输出到剪贴板",
  "diagnostics.copyFail": "复制失败，请手动框选复制",
  ...
  "diagnostics.perfConcurrentWorkers": "最大并发路数",
  ...
  "diagnostics.perfConcurrentWorkersN": "{n} 路并行",
  "diagnostics.perfConcurrentModelCount": "实测 {n} 个模型",
  "diagnostics.perfConcurrentSerial": "串行",
  "diagnostics.perfConcurrentPerModel": "平均/模型 {ms}ms",
  "diagnostics.perfConcurrentRow": "并行 {workers} 路",
  "diagnostics.perfConcurrentSpeedup": "{speedup}x",
  "diagnostics.perfConcurrentJudgeHint": "加速比判决由 Go 单点给出；前端只做展示，阈值不在前端重算",
  "diagnostics.perfConcurrentVerdictExcellent": "优秀",
  "diagnostics.perfConcurrentVerdictGood": "良好",
  "diagnostics.perfConcurrentVerdictFair": "一般",
  ...
  "diagnostics.perfConcurrentParamInvalid":
    "并发参数无效：并发路数须为 1~256、取样上限须 ≥ 1，且目标集不能选「单模型」（并发没有模型路径输入）",
  ...
  "diagnostics.perfScanBenchColMedian": "中位",
  "diagnostics.perfScanBenchColP95": "p95 分位",
  "diagnostics.perfScanBenchColEntries": "条目",
  "diagnostics.perfScanBenchColStatus": "状态",
  "diagnostics.perfScanBenchMeasured": "实测",
  "diagnostics.perfScanBenchNotMeasured": "未采集",
  "diagnostics.perfScanBenchSamplesHint": "逐次样本（{n} 次）：{runs}",
  "diagnostics.perfScanBenchSkipped": "另有 {n} 次未计入样本（缓存命中 / 归属不可判定）",
  "diagnostics.perfScanBenchReasonUnavailable": "本构建未启用 rust_backend",
  "diagnostics.perfScanBenchReasonFellBack": "Rust 后端本次未处理（运行期不可用，已回退 Go）",
  "diagnostics.perfScanBenchReasonCacheHit": "扫描缓存命中，未走引擎",
  "diagnostics.perfScanBenchReasonInterfered": "并发扫描交叉，归属不可判定",
  "diagnostics.perfScanBenchReasonUnknown": "未采集（原因 {reason}）",
  "diagnostics.perfScanBenchParity": "跨引擎一致性",
  "diagnostics.perfScanBenchParityMatch": "条目集合与关键字段逐条一致",
  "diagnostics.perfScanBenchParityMismatch": "存在分叉",
  "diagnostics.perfScanBenchParityNotComparable": "无法比对（两侧未同时采集）",
  "diagnostics.perfScanBenchOnlyGo": "仅 Go 扫到",
  "diagnostics.perfScanBenchOnlyRust": "仅 Rust 扫到",
  "diagnostics.perfScanBenchFieldDiff": "字段不一致",
  ...
  "diagnostics.perfTarget": "测什么",
  "diagnostics.perfTargetModel": "我填的这个模型",
  "diagnostics.perfTargetAll": "每个类型各取几条",
  ...
  "diagnostics.perfTargetAllHint":
    "每个类型各取几条：扫描注册表里的**所有**类型（含 CLI 不可分析的类型，这类只出身份、不采集阶段耗时）",
  "diagnostics.perfTargetRepo": "全库最重的几条（不分类型）",
  "diagnostics.perfTargetRepoHint":
    "全库最重的几条：不按类型分组，全库按排序取前 N 条；仅结构化 JSON 载荷",
  "diagnostics.perfTargetNameRtype": "{rtype} 类型",
  "diagnostics.perfTargetGroupModel": "单个模型",
  "diagnostics.perfTargetGroupType": "按模型类型",
  "diagnostics.perfTargetGroupCross": "跨类型对比（进阶）",
  "diagnostics.perfTargetSetEcho": "测什么 {target} · 排序 {order} · 上限 {n}",
  ...
  "diagnostics.loadTraceCount": "本会话共 {n} 条记录（最多保留 {max} 条）",
  "diagnostics.loadTraceMoreRecords": "还有 {n} 条更早的记录未显示",
  "diagnostics.loadTraceStages": "{n} 段",
  "diagnostics.loadTraceCoarseHint": "该格式只记了 1 段合并耗时（各 adapter 计时粒度不同）",
  "diagnostics.loadTraceGpuUncollected": "未采集",
  "diagnostics.metric.assetsBones": "骨骼数",
  ...
  "content.localModelsCount": "本地拥有 {n} 个模型",
  ...
  "content.noMatchCreators": "没有符合条件的创作者",
  "content.clearFilter": "清除筛选",
  "content.tierGold": "本地模型数 Top 10%",
  ...
  "workshop.discardTitle": "放弃未保存的修改？",
  "workshop.discardMessage": "退出编辑将丢弃尚未保存的创作者/搜索词修改。",
  "workshop.discardConfirm": "放弃修改",
  "workshop.download": "下载",
  "workshop.configureRepo": "请先配置仓库目录",
  "workshop.enqueueFailed": "入队失败",
  "workshop.loadCommunityFailed": "加载社区数据失败",
  ...
  "workshop.logGithub": "GitHub: {n} 仓库",
  "workshop.logTypes": "类型: {n} 种",
  "workshop.upToDate": "🌐 已是最新配置",
  "workshop.networkOffline": "🌐 无网络连接，请检查网络后重试",
  "workshop.indexMissing": "📭 社区索引文件不存在",
  "workshop.rateLimited": "GitHub API 频率限制，请稍后重试",
  "workshop.fetchFailed": "拉取失败",
  "workshop.updateConfig": "🌐 更新配置",
  ...
  "workshop.rateLimitedGithub": "GitHub API 频率限制，请稍后重试或改用浏览器打开",
  "workshop.githubLoadFailed": "加载失败，请检查网络或稍后重试",
  // 创作者身份角色标签（workshop-data getCreatorIdentity）
  "workshop.roleOfficial": "官方IP模型库",
  "workshop.roleCreator": "YSM 创作者",
  "workshop.roleVup": "VTuber 创作者",
  "workshop.roleRepo": "社区模型仓库",
  "workshop.roleOc": "OC 原创角色",
  "workshop.title": "创意工坊",
  ...
  "sidebar.pushDone": "推送完成，{detail}",
  "sidebar.pushFailed": "推送失败: {msg}",
  "sidebar.pullDoneAll": "拉取完成，共 {n} 个文件",
  "sidebar.pullDone": "拉取完成: {pulled} 个文件, {failed} 个失败",
  ...
  "syncManager.scanDirWide":
    "{label} 仓库基准目录 {dir} 疑似过宽（含 mods/config/schematics 等子目录），同步可能混入其他资源；建议将专属根指向专门的 {subDir} 子目录",
  ...
  // P2：右键菜单行为 toast 全量 i18n（handler 层收敛）
  "ctx.busyWait": "操作进行中，请稍候",
  "ctx.moveProgress": "📦 正在移动 {n} 个文件到 {folder}...",
  "ctx.copyProgress": "📦 正在复制 {n} 个文件到 {folder}...",
  "ctx.moveOkAll": "{n} 个文件已移动到 {folder}",
  "ctx.copyOkAll": "{n} 个文件已复制到 {folder}",
  "ctx.moveOkPartial": "{ok} 个已移动 / {fail} 失败",
  "ctx.copyOkPartial": "{ok} 个已复制 / {fail} 失败（可能目标已存在）",
  "ctx.moveFailAll": "移动失败",
  "ctx.copyFailAll": "复制失败（可能目标已存在）",
  "ctx.moveDialogTitle": "移动到文件夹",
  "ctx.copyDialogTitle": "复制到文件夹",
  "ctx.moveDialogOk": "移动",
  "ctx.copyDialogOk": "复制",
  "ctx.emptyMoveRoot": "请先配置存储路径",
  "ctx.emptyCopyRoot": "请先配置仓库目录",
  "ctx.recycleTitle": "批量移入回收站",
  "ctx.recycleConfirm": "确定将选中的 {n} 个文件移入回收站？",
  "ctx.recycleOkText": "移入",
  "ctx.recycleFailN": "{fail} 个文件移入回收站失败：{err}",
  "ctx.recycleOkN": "{n} 个文件已移入回收站",
  "ctx.renameFail": "重命名失败",
  "ctx.fileMoveOk": "已移动到 {folder}",
  "ctx.fileCopyOk": "已复制到 {folder}",
  "ctx.moveFail": "移动失败",
  "ctx.copyFail": "复制失败",
  "ctx.pushNoMcRoot": "请先配置游戏目录",
  "ctx.pushNoInstances": "未找到任何整合包",
  "ctx.pushDialogTitle": "推送到整合包",
  "ctx.pushOkText": "推送",
  "ctx.pushOk": "已推送到 {pack}",
  "ctx.pushFail": "推送失败",
  "ctx.tagsSaved": "已保存 {n} 个标签",
  "ctx.tagsFail": "标签编辑失败",
  "ctx.fileRecycleTitle": "移入回收站",
  "ctx.fileRecycleConfirm": "确定将 {name} 移入回收站？",
  "ctx.recycleFail": "移入回收站失败",
  "ctx.revealFail": "打开失败",
  "ctx.copyPathOk": "路径已复制到剪贴板",
  "ctx.copyPathFail": "复制失败，请手动复制路径",
  "ctx.dirMoveDialogTitle": "移动文件夹到",
  "ctx.dirCopyDialogTitle": "复制文件夹到",
  "ctx.dirMoveOk": "已移动文件夹到 {folder}",
  "ctx.dirCopyOk": "已复制文件夹到 {folder}",
  "ctx.openFolderFail": "打开文件夹失败",
  "ctx.exportListOk": "已导出 {n} 个文件名",
  "ctx.dstPlaceholder": "输入目标文件夹名，如 [作者名]",
  "ctx.unsafeFolderName": "文件夹名包含非法字符",
  ...
  "inst.clearOk": "清空",
  "inst.cancelled": "已取消",
  "inst.cleared": "{name}: 已清空 {n} 个文件（移入回收站）",
  ...
  "diagnostics.opUI": "界面",
  "diagnostics.searchPlaceholder": "搜索日志内容...",
  ...
  "diagnostics.noInstances": "未找到可用整合包（先配置游戏目录并安装整合包）",
  ...
  "diagnostics.healthHitRateUnavailable": "命中率不可用",
  ...
  "community.downloadQueue.webDlFailed":
    "{imported} 个已入模型库，{fallback} 个走浏览器直链保存，{failed} 个失败",
  ...
  "preview.largeModelWarn": "大文件（{size}MB）解码峰值内存可达 {peak}MB，低端设备可能卡顿或崩溃",
  "preview.gpuBudgetAppend": "GPU 负载已超预算（{reasons}），无法继续追加",
  "preview.gpuBudgetLoad": "GPU 负载已超预算（{reasons}），无法继续加载",
  ...
  "preview.loadingModels": "⏳ 加载模型列表中...",
  "preview.authors": "作者",
  "preview.modelOverview": "模型概览",
  "preview.extraTextures": "含 {extra} 张额外纹理（共 {total} 张）",
  "preview.inventory": "包内文件",
  "preview.inventory.animations": "动画",
  "preview.inventory.controllers": "控制器",
  "preview.inventory.langFiles": "语言",
  "preview.inventory.legacyModels": "旧格式",
  "preview.inventory.avatars": "头像",
  "preview.roleTexCount": "角色纹理 {role} 张 · 独立模型 {comp} 张",
  "preview.rolesList": "L0 清单角色（{n}）",
  "preview.modelStructure": "模型结构",
  "preview.label.boneCount": "骨骼数",
  "preview.cubesLabel": "立方体 (Cubes)",
  "preview.unit": "个",
  "preview.textureSize": "纹理尺寸",
  "preview.px": "px",
  "preview.fileInfo": "文件信息",
  "preview.decodedBy.wasm": "WASM 内置解码",
  "preview.decodedBy.json": "JSON 直接解析",
  "preview.decodedBy.go": "Go 原生解析",
  "preview.decodedBy.goSingle": "Go 单角色（L0）",
  ...
  "preview.volumetricDriverHint":
    "自动 = 第一盏启用的聚光灯；指定灯 = 该灯须为启用的聚光灯，否则无光锥",
  "preview.volumetricDensity": "浓度",
  "preview.volumetricFalloff": "衰减",
  "preview.volumetricEdgeFade": "边缘羽化",
  "preview.volumetricTipRatio": "上下亮度比",
  "preview.lightResetAll": "重置全部灯光",
  "preview.lightResetAllHint": "三盏灯、环境光与体积光全部回到默认值",
  "preview.lighting": "灯光",
  "preview.lightSelect": "编辑灯光",
  "preview.lightHelper": "灯光辅助线",
  "preview.lightHelperHint": "视口内显示三盏灯的来向线框（仅编辑辅助，不随截图输出）",
  ...
  "preview.envSource": "来源",
  "preview.envSourceHint":
    "环境贴图由谁提供：预设用程序化光照，跟随天空取实时天空烘焙（天空变化即时反映），自定义读取本地 HDR 文件",
  "preview.envSourcePreset": "预设",
  "preview.envSourceSky": "跟随天空",
  "preview.envSourceCustom": "自定义 HDR",
  "preview.envIntensity": "环境强度",
  "preview.envHistogram": "亮度直方图",
  "preview.envPickHdr": "自定义 HDR",
  "preview.envPickHdrBtn": "选择 HDR 文件",
  "preview.envSectionBasic": "基础",
  "preview.envSectionAtmosphere": "氛围",
  "preview.envSectionOther": "其它",
  ...
  "preview.skySunIntensityScale": "天空×太阳耦合",
  "preview.skySunIntensityScaleHint": "整体调亮/调暗太阳与天空的耦合强度",
  "preview.skySunDiscScale": "太阳盘强度",
  "preview.skySunDiscScaleHint": "控制太阳光斑的视觉大小与亮度",
  ...
  "preview.settingsPerfCustom": "自定义",
  ...
  "preview.wireframeDesc": "显示网格拓扑结构",
  "preview.renderMode": "渲染模式",
  "preview.renderModeDesc": "线框/混合/深度测试/面剔除等渲染属性覆盖",
  "preview.renderModeBlending": "混合模式",
  "preview.renderModeXray": "X光透视",
  "preview.renderModeXrayDesc": "关闭深度测试，可看穿模型内部",
  "preview.renderModeSide": "面剔除",
  "preview.renderModeDepthWrite": "深度写入",
  "preview.renderModeDepthWriteDesc": "关闭后透明物体排序更准确",
  "preview.shadow": "阴影",
  ...
  "preview.groundOverlay": "叠加样式",
  "preview.groundOverlayColor": "叠加线色",
  "preview.groundOverlaySize": "叠加格数",
  "preview.groundOverlayOpacity": "叠加不透明度",
  "preview.groundMatColor": "底色",
  "preview.groundMatGridSize": "格数",
  "preview.groundMatColor2": "副色",
  ...
  "preview.water": "水面",
  "preview.waterDesc": "程序化水面：薄膜/泳池两态，带动态波纹与反射",
  "preview.waterGroupForm": "形态",
  "preview.waterGroupLook": "外观",
  "preview.waterGroupPool": "水池",
  "preview.waterGroupWave": "波纹",
  "preview.waterGroupReflect": "倒影",
  ...
  "preview.materialUnnamed": "材质 #{n}",
  "preview.formatVersion": "格式版本",
  "preview.metric.boneCount": "骨骼数",
  ...
  "preview.stagePerformanceLabel": "舞台表演包",
  ...
  // ── 3D 选项文案（select / preset-thumb 下拉项；2026-09 全仓归一，禁硬编码中文）──
  "preview.groundMatSourceNone": "无",
  "preview.groundMatSourceSolid": "纯色",
  "preview.groundMatSourceCanvas": "程序化画布",
  "preview.groundMatSourceTexture": "自定义贴图",
  "preview.groundCanvasStylePlain": "素面",
  "preview.groundCanvasStyleMarble": "大理石",
  "preview.groundCanvasStyleSand": "沙子",
  "preview.groundCanvasStyleGrass": "草地",
  "preview.groundCanvasStyleCustom": "自定义（已手改）",
  "preview.groundOverlayNone": "无",
  "preview.groundOverlayGrid": "格线",
  "preview.groundOverlayChecker": "棋盘",
  "preview.groundOverlayStripes": "条纹",
  "preview.groundOverlayDiamond": "菱格",
  "preview.waterModeFilm": "薄膜",
  "preview.waterLevel": "水位",
  "preview.waterSize": "水面尺寸",
  "preview.waterModePool": "水池",
  ...
  "preview.reflectionModeEnvmapOnly": "仅环境贴图",
  "preview.reflectionModeEnvmapSsr": "环境贴图 + 屏幕空间",
  "preview.reflectionModeSsrOnly": "仅屏幕空间",
  "preview.renderModeBlendingNormal": "正常",
  "preview.renderModeBlendingAdditive": "叠加",
  "preview.renderModeBlendingMultiply": "正片叠底",
  "preview.renderModeBlendingSubtractive": "减去",
  "preview.renderModeSideFront": "正面",
  "preview.renderModeSideBack": "背面",
  "preview.renderModeSideDouble": "双面",
  "preview.shadowMapSize512": "512（性能优先）",
  "preview.shadowMapSize1024": "1024（均衡）",
  "preview.shadowMapSize2048": "2048（清晰）",
  "preview.shadowMapSize4096": "4096（精细）",
  "preview.cameraRotationOrbit": "环绕",
  "preview.cameraRotationFree": "自身",
  "preview.sliceModeAll": "全部",
  "preview.sliceModeSingle": "单层",
  "preview.sliceModeRange": "范围",
  // ── 资源包模型清单（ADR-131 P3）──
  ...
  "preview.sliceLayer": "层",
  "preview.sliceRangeStart": "起",
  "preview.sliceRangeEnd": "止",
  ...
  "preview.mmdPlay": "播放",
  "preview.mmdMotion": "动作",
  "preview.playEmpty": "无内置动作",
  "preview.playNotice": "VMD 动作版权归配布者所有，使用前请确认配布条款。",
  "preview.vmdPositionScale": "VMD 位移缩放",
  "preview.vmdPositionScaleReset": "重置位移缩放（自动）",
  "preview.playReload": "重新扫描",
  "preview.mmdMorph": "表情",
  ...
  "preview.allowedUser": "用户",
  "preview.sexual": "性",
  "preview.violent": "暴力",
  "preview.fbxModel": "FBX 模型/动画",
  "preview.label.bones": "骨骼",
  "preview.texturesLabel": "纹理",
  ...
  "preview.bone.detail.name": "名称",
  "preview.bone.detail.path": "路径",
  "preview.bone.detail.position": "坐标",
  "preview.bone.detail.parent": "父骨骼",
  "preview.bone.detail.children": "子骨骼",
  "preview.bone.detail.root": "（根）",
  ...
  "tree.dirRenameOk": "✂️ 重命名",
  "tree.mkdirTitle": "新建文件夹",
  "tree.mkdirOk": "创建",
  "tree.dirRecycleConfirm": "确定将文件夹移入回收站？\n{dir}",
  "tree.dirRecycleOk": "移入回收站",
  "tree.recycledFailSuffix": "，失败 {fail} 个（{detail}）",
  "tree.webNoToggle": "网页版不支持启用/禁用模型",
  "tree.batchBusyWait": "⏳ 批量操作进行中，请稍候",
  "tree.toggleFail": "切换失败: {name}",
  "tree.selectedCount": "已选 {n} 个文件",
  "tree.folderToggleResult": "文件夹{action}: {ok} 成功, {fail} 失败",
  "tree.batchToggleFail": "批量启用/禁用失败",
  "tree.importFail": "导入失败: {msg}",
  "tree.advFilterFail": "高级筛选失败",
  "tree.selectFileTitle": "选择{rtype}文件",
  "tree.importFileFilter": "{rtype} 文件",
  "tree.importOk": "导入成功",
  "tree.importDirOk": "文件夹导入成功",
  "tree.needStoragePath": "请先配置存储路径",
  "tree.indexGenerated": "index.json 已生成",
  "tree.tagQueryFail": "标签查询失败: {msg}",
  "tree.needRepoDir": "请先配置仓库目录",
  "tree.webStatsDegraded": "网页版统计引擎不可用，骨骼/立方体数值条件已忽略（仅关键词匹配）",
  "tree.statsBadgePreparing": "×{n} 准备统计…",
  "tree.statsBadgeWorkers": "×{n} worker",
  "tree.statsBadgeDegraded": "Worker 降级 · 数值条件忽略",
  "tree.filterFound": "🔍 找到 {n} 个匹配",
  "tree.filterNone": "🔍 无匹配模型（已应用筛选）",
  "tree.webImportPartial": "{imported} 个导入成功，{failed} 个失败",
  "tree.webImportOk": "{imported} 个模型已导入浏览器模型库",
  "tree.webNoDelete": "网页版不支持删除模型",
  "tree.batchDeleteTitle": "批量删除",
  "tree.batchDeleteConfirm": "确定要删除选中的 {n} 个文件吗？",
  "tree.deleteOk": "删除",
  "tree.noModelFiles": "暂无模型文件",
  "tree.noMatchFiles": "未找到匹配的文件",
  "tree.moreRefresh": "刷新",
  ...
  "webFs.filesLimit": "文件总数超过 {limit} 上限（当前 {count}），请检查授权目录范围",
