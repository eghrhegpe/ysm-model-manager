...
export const zhCN = {
  ...
  "settings.keymap.conflict": "⚠️ {key} 已被「{label}」占用",
  "settings.keymap.bound": "✅ {label} → {key}",
  "settings.keymap.resetDone": "↩️ 已恢复默认键位",
  ...
  "diagnostics.perfCopyFail": "复制失败，请手动框选复制",
  ...
  "workshop.rateLimited": "⏱️ GitHub API 频率限制，请稍后重试",
  ...
  "workshop.rateLimitedGithub": "⏱️ GitHub API 频率限制，请稍后重试或改用浏览器打开",
  ...
  "tree.statsBadgeDegraded": "⚠️ Worker 降级 · 数值条件忽略",
