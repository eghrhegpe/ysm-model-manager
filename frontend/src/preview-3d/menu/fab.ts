...
.preview-dock-nav{position:absolute;left:12px;bottom:12px;display:flex;gap:2px;padding:4px;border-radius:var(--radius-sm);background:var(--surf);border:1px solid var(--bd);box-shadow:0 3px 10px rgba(0,0,0,.28);z-index:20}
