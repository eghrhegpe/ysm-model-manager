...
import { attenuateAmbientForSky, type DirectionalLightParams } from "@/preview-3d/caps/light-capability.ts";
import { isSkyEnvironmentOn, sceneCapabilityRegistry } from "@/preview-3d/caps/scene-capability-registry.ts";
