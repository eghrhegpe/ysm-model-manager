...
// 网页版 NBT/体素解析（nbt-parse.ts / voxel-bits.ts / voxel-pipeline.ts 等）共用的一组无状态类型守卫。
...
export function getCompound(o: unknown, key: string): Record<string, unknown> | undefined {
