// ===== <app-content> 样式组合层（按职责拆分为 7 个域文件）=====
...
// content-diag     : 诊断(diag-/perf-/log-/conflict-/scan-) + 二级菜单 + 队列 + 诊断配置面板(diag-config-/diag-warn)
// content-gh       : 工坊 GitHub .gh-* 全族（2026-09 自 content-diag 按页面域拆分）
