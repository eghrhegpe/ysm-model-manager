...
import { mount3D, type PreviewAdapter, type Mount3DOptions } from "../../preview-3d/adapters/mount-preview-core.ts";
import { buildFbxScene, type FbxDataPort } from "../../preview-3d/adapters/fbx-adapter.ts";
