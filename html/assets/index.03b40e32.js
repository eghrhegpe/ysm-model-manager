...
</div>`}function B(t,e){return`<div class="empty"><div class="big">${t}</div>${e}</div>`}function y(t){return(t||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Z(t,e){const n=y(t);if(!e)return n;const o=e.toLowerCase(),s=t.toLowerCase().indexOf(o);if(s===-1)return n;const a=y(t.substring(0,s)),i=y(t.substring(s,s+e.length)),r=y(t.substring(s+e.length));return a+"<mark>"+i+"</mark>"+r}function tt(t){return!t&&t!==0?"":t<1024?t+" B":t<1048576?(t/1024).toFixed(1)+" KB":(t/1048576).toFixed(1)+" MB"}function et(t){if(!t)return"";const e=new Date(t),n=new Date;return e.toDateString()===n.toDateString()?e.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):(n-e)/864e5<7?["\u65E5","\u4E00","\u4E8C","\u4E09","\u56DB","\u4E94","\u516D"][e.getDay()]+" "+e.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):e.toLocaleDateString([],{month:"short",day:"numeric"})}function nt(t){const e=(t.split(".").pop()||"").toLowerCase();return e==="ysm"?"\u{1F48E}":["zip","rar","7z","tar","gz"].includes(e)?"\u{1F4E6}":["png","jpg","jpeg","gif","webp","bmp"].includes(e)?"\u{1F5BC}\uFE0F":["txt","md","json","xml","yml","yaml","cfg","conf","ini"].includes(e)?"\u{1F4C4}":"\u{1F9CA}"}function st(t,e,n){const o=[...t].sort((i,r)=>e==="size"?(r.size||0)-(i.size||0):e==="date"?(r.modTime||0)-(i.modTime||0):i.name.localeCompare(r.name)),s=(n||"").trim().toLowerCase(),a={};return o.forEach(i=>{if(s&&!i.name.toLowerCase().includes(s))return;const r=i.path.replace(/\\/g,"/").split("/");let l=a;for(let c=0;c<r.length-1;c++)!r[c]||(l[r[c]]||(l[r[c]]={}),l=l[r[c]]);l[r[r.length-1]]={_e:i}}),a}function N(t,e){if(!e||!t)return!1;for(const n of Object.keys(t)){const o=t[n];if(o._e){if(o._e.name.toLowerCase().includes(e))return!0}else if(n.toLowerCase().includes(e)||N(o,e))return!0}return!1}function ot(t){const e=t.length,n=t.filter(s=>!s.banned).length,o=t.reduce((s,a)=>s+(a.size||0),0);return{total:e,enabled:n,totalSize:o}}function at(t,e,n,o){const s=_(t.path),a=_(t.fullPath||t.path),i=t.banned?"":" on",r=t.banned?"":"\u2713";return`<div class="fl${t.banned?" ban":""}" data-path="${s}" data-fullpath="${a}">
<span class="ck${i}" data-path="${s}" data-fullpath="${a}">${r}</span>
<span class="ficon">${n}</span>
<span class="nm">${e}</span>
<span class="sz">${rt(t.size)}</span>${o?`<span class="dt">${o}</span>`:""}</div>`}function it(t,e,n,o){const s=o?"\u{1F512}":"\u{1F4C1}",a=o?"#585b70":"#a6adc8",i=o?" locked":"",r=n?"\u25BC":"\u25B6",l=n?" open":"";return`<div class="fh${i}" data-dir="${_(e)}">
<span class="ar${l}">${r}</span>
<span class="nm" style="color:${a}">${s} ${_(t)}</span></div>
<div class="ch" style="display:${n?"block":"none"}">`}function _(t){return(t||"").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function rt(t){return!t&&t!==0?"":t<1024?t+" B":t<1048576?(t/1024).toFixed(1)+" KB":(t/1048576).toFixed(1)+" MB"}function ct(t,e,n,o,s){if(!e.length){t.innerHTML=B("\u{1F4C1}","\u6682\u65E0\u6A21\u578B\u6587\u4EF6");return}const a=st(e,o,n),i=q(a,"",n,o,s);if(!i){t.innerHTML=B("\u{1F50D}","\u672A\u627E\u5230\u5339\u914D\u7684\u6587\u4EF6");return}t.innerHTML=i}function lt(t,e){if(!t)return;const n=ot(e);t.textContent=`\u5171 ${n.total} \u9879 (\u5DF2\u542F\u7528 ${n.enabled}) \xB7 ${tt(n.totalSize)}`}function q(t,e,n,o,s){const a=!!(n||"").trim(),i=Object.keys(t).sort((l,c)=>{const d=!t[l]._e,p=!t[c]._e;if(d&&!p)return-1;if(!d&&p)return 1;const f=t[l]._e,u=t[c]._e;return o==="size"?((u==null?void 0:u.size)||0)-((f==null?void 0:f.size)||0):o==="date"?((u==null?void 0:u.modTime)||0)-((f==null?void 0:f.modTime)||0):l.localeCompare(c)});let r="";return i.forEach(l=>{const c=t[l],d=e?e+"/"+l:l;if(c._e){const p=c._e;if(a&&!p.name.toLowerCase().includes(n.toLowerCase()))return;const f=a?Z(p.name,n):p.name,u=p.modTime?et(p.modTime):"",m=nt(p.name);r+=at(p,f,m,u)}else{const p=l.startsWith("_"),f=a||!!s[d],u=a?N(c,n.toLowerCase()):!1;r+=it(l,d,f||a&&u,p),r+=q(c,d,n,o,s),r+="</div>"}}),r}function P(t){!t||(t.classList.add("flash"),setTimeout(()=>t.classList.remove("flash"),400))}function dt(t,e){t.querySelectorAll(".fh").forEach(n=>{n.onclick=o=>{o.stopPropagation();const s=n.nextElementSibling,a=n.querySelector(".ar");if(!s)return;const i=s.style.display!=="none";s.style.display=i?"none":"block",a.classList.toggle("open",!i),e._dirOpen[n.dataset.dir]=!i,localStorage.setItem("at_dirs",JSON.stringify(e._dirOpen))}}),t.querySelectorAll(".ck").forEach(n=>{n.onclick=o=>{o.stopPropagation();const s=n.classList.contains("on");n.classList.toggle("on"),n.textContent=n.classList.contains("on")?"\u2713":"";const a=n.closest(".fl");a&&a.classList.add("flash"),setTimeout(()=>a==null?void 0:a.classList.remove("flash"),400);const i=n.dataset.path,r=n.dataset.fullpath||i;bus.emit("entry:toggle",{path:r,relPath:i,enabled:!s})}}),t.querySelectorAll(".fh").forEach(n=>{n.oncontextmenu=o=>{o.preventDefault(),o.stopPropagation(),bus.emit("ctx:show",{x:o.clientX,y:o.clientY,type:"dir",dir:n.dataset.dir})}}),t.querySelectorAll(".fl").forEach(n=>{n.oncontextmenu=o=>{var i;o.preventDefault(),o.stopPropagation();const s=!((i=n.querySelector(".ck"))!=null&&i.classList.contains("on")),a=n.dataset.fullpath||n.dataset.path;bus.emit("ctx:show",{x:o.clientX,y:o.clientY,type:"file",path:a,banned:s})}})}function pt(t,e){var s,a,i,r,l,c,d,p,f;const n=u=>t.getElementById(u),o=()=>e._renderTree();(s=n("srch"))==null||s.addEventListener("input",u=>{e._search=u.target.value,o()}),(a=n("sort"))==null||a.addEventListener("change",u=>{e._sort=u.target.value,o()}),(i=n("btn-repo"))==null||i.addEventListener("click",()=>bus.emit("dir:select-repo")),(r=n("btn-dedup"))==null||r.addEventListener("click",()=>bus.emit("entries:dedup")),(l=n("btn-trash"))==null||l.addEventListener("click",()=>bus.emit("recycle:open")),(c=n("btn-pv"))==null||c.addEventListener("click",()=>bus.emit("preview:toggle")),(d=n("btn-ea"))==null||d.addEventListener("click",()=>{P(n("btn-ea")),e._entries.forEach(u=>{u.banned=!1}),o()}),(p=n("btn-da"))==null||p.addEventListener("click",()=>{P(n("btn-da")),e._entries.forEach(u=>{u.banned=!0}),o()}),(f=n("btn-st"))==null||f.addEventListener("click",()=>{bus.emit("sync:toggle-status")})}function w(t,e,n,o,s,a){return window.go.main.App.AddImportLog(t,e,n,o,s,a)}function ut(t){return window.go.main.App.AnalyzeYSMModel(t)}function ft(t){return window.go.main.App.CheckFileExists(t)}function gt(t){return window.go.main.App.ClearCustomDir(t)}function mt(){return window.go.main.App.ClearImportLogs()}function ht(t){return window.go.main.App.CountLinkedModels(t)}function bt(t){return window.go.main.App.CreateDir(t)}function xt(t){return window.go.main.App.DeduplicateCustomDir(t)}function vt(t){return window.go.main.App.DeleteFromRecycle(t)}function yt(t){return window.go.main.App.EmptyRecycleBin(t)}function wt(t){return window.go.main.App.GetGlobalCustomDir(t)}function _t(){return window.go.main.App.GetImportLogs()}function Y(t,e){return window.go.main.App.GetInstanceStatus(t,e)}function kt(){return window.go.main.App.GetLinkMode()}function St(){return window.go.main.App.GetMinecraftPath()}function Lt(){return window.go.main.App.GetWindowPosition()}function Et(t){return window.go.main.App.HasYSMMod(t)}function Mt(t,e){return window.go.main.App.ImportModelFile(t,e)}function Tt(t,e){return window.go.main.App.InstallModelFile(t,e)}function zt(t,e){return window.go.main.App.InstallModelTo(t,e)}function Ct(t,e){return window.go.main.App.InstallModelWithOverlay(t,e)}function V(t){return window.go.main.App.IsFileBanned(t)}function $t(t){return window.go.main.App.IsSymlink(t)}function Rt(t){return window.go.main.App.ListFileNames(t)}function At(t){return window.go.main.App.ListRecycleBin(t)}function A(t){return window.go.main.App.ListVersionInstances(t)}function v(){return window.go.main.App.LoadAppConfig()}function It(t,e){return window.go.main.App.MoveModelFile(t,e)}function Ht(t){return window.go.main.App.MoveToRecycle(t)}function Dt(t){return window.go.main.App.MoveToRecycleEx(t)}function Bt(t){return window.go.main.App.OpenFolder(t)}function Pt(t,e){return window.go.main.App.RestoreFromRecycle(t,e)}function I(t,e,n){return window.go.main.App.SaveAppConfig(t,e,n)}function Ft(t,e,n,o){return window.go.main.App.SaveWindowPosition(t,e,n,o)}function Ot(t){return window.go.main.App.ScanCustomModels(t)}function H(t){return window.go.main.App.ScanModelEntries(t)}function D(){return window.go.main.App.SelectDirectory()}function jt(t){return window.go.main.App.SetLinkMode(t)}function Gt(t){return window.go.main.App.SetRepoRoot(t)}function Nt(t,e){return window.go.main.App.SyncCustomToRepo(t,e)}function U(t,e){return window.go.main.App.SyncModelToggleStatus(t,e)}function W(t){return window.go.main.App.ToggleModelEnable(t)}const h=Object.freeze(Object.defineProperty({__proto__:null,AddImportLog:w,AnalyzeYSMModel:ut,CheckFileExists:ft,ClearCustomDir:gt,ClearImportLogs:mt,CountLinkedModels:ht,CreateDir:bt,DeduplicateCustomDir:xt,DeleteFromRecycle:vt,EmptyRecycleBin:yt,GetGlobalCustomDir:wt,GetImportLogs:_t,GetInstanceStatus:Y,GetLinkMode:kt,GetMinecraftPath:St,GetWindowPosition:Lt,HasYSMMod:Et,ImportModelFile:Mt,InstallModelFile:Tt,InstallModelTo:zt,InstallModelWithOverlay:Ct,IsFileBanned:V,IsSymlink:$t,ListFileNames:Rt,ListRecycleBin:At,ListVersionInstances:A,LoadAppConfig:v,MoveModelFile:It,MoveToRecycle:Ht,MoveToRecycleEx:Dt,OpenFolder:Bt,RestoreFromRecycle:Pt,SaveAppConfig:I,SaveWindowPosition:Ft,ScanCustomModels:Ot,ScanModelEntries:H,SelectDirectory:D,SetLinkMode:jt,SetRepoRoot:Gt,SyncCustomToRepo:Nt,SyncModelToggleStatus:U,ToggleModelEnable:W},Symbol.toStringTag,{value:"Module"}));async function qt(){const t=await v(),e=t.repoRoot||t.RepoRoot||"";if(!e)return null;const n=await H(e);if(!n||!n.length)return null;const o=[];for(const s of n){let a=!1;try{a=await V(s.Path)}catch{}let i=s.Path;e&&s.Path.startsWith(e)&&(i=s.Path.slice(e.length).replace(/^[/\\]+/,"")),o.push({name:s.Name,path:i,fullPath:s.Path,size:s.Size,modTime:s.ModTime,banned:a})}return{repoRoot:e,entries:o}}function R(){const t=Date.now();return[{name:"steve_skin.ysm",path:"steve_skin.ysm",size:1258291,modTime:t-864e5,banned:!1},{name:"alex_deluxe.ysm",path:"alex/alex_deluxe.ysm",size:2516582,modTime:t-1728e5,banned:!1},{name:"alex_head.ysm",path:"alex/alex_head.ysm",size:524288,modTime:t-1728e5,banned:!1},{name:"dragon_armor.zip",path:"dragon/dragon_armor.zip",size:3984588,modTime:t-36e5,banned:!1},{name:"dragon_wings.ysm",path:"dragon/dragon_wings.ysm",size:2202009,modTime:t-72e5,banned:!1},{name:"neon_sword.ysm",path:"weapons/neon_sword.ysm",size:1572864,modTime:t,banned:!1},{name:"magic_staff.zip",path:"weapons/magic_staff.zip",size:4404019,modTime:t-72e5,banned:!1},{name:"photon_body.ysm",path:"photon/photon_body.ysm",size:2202009,modTime:t-432e5,banned:!1},{name:"old_model.ysm",path:"_disabled/old_model.ysm",size:943718,modTime:t-6048e5,banned:!0},{name:"custom_hat.ysm",path:"custom/custom_hat.ysm",size:838860,modTime:t-2592e5,banned:!1},{name:"steve_2d.ysm",path:"custom/steve_2d.ysm",size:314572,modTime:t-5e5,banned:!1}]}function Yt(t){const e=[];return e.push(bus.on("entry:toggle",async({path:n})=>{try{await W(n)}catch{}await reload(t)})),e.push(bus.on("dir:select-repo",async()=>{try{const n=await D();if(!n)return;await I(n,"","copy"),t._repoRoot=n,await reload(t)}catch{t._entries=R(),t._renderTree()}})),e.push(bus.on("entries:dedup",()=>{bus.emit("toast:show",{msg:"\u{1F517} \u53BB\u91CD\u529F\u80FD\u5F00\u53D1\u4E2D",duration:2e3,type:"info"})})),e.push(bus.on("recycle:open",()=>{bus.emit("toast:show",{msg:"\u{1F5D1}\uFE0F \u56DE\u6536\u7AD9\u529F\u80FD\u5F00\u53D1\u4E2D",duration:2e3,type:"info"})})),e.push(bus.on("batch:enable",({dir:n})=>{batchToggle(t,n,!0)})),e.push(bus.on("batch:disable",({dir:n})=>{batchToggle(t,n,!1)})),e.push(bus.on("sync:toggle-status",async()=>{try{const n=await v(),o=n.repoRoot||n.RepoRoot||"",s=n.mcRoot||n.McRoot||"";if(!o||!s){bus.emit("toast:show",{msg:"\u8BF7\u5148\u914D\u7F6E\u6E38\u620F\u76EE\u5F55\u548C\u4ED3\u5E93\u76EE\u5F55",duration:3e3,type:"warn"});return}const a=await A(s);if(!a||!a.length){bus.emit("toast:show",{msg:"\u6CA1\u6709\u627E\u5230\u6574\u5408\u5305",duration:2e3,type:"info"});return}let i=0,r=0;for(const l of a)if(!!l.Exists)try{const c=await U(l.CustomDir,o),d=c.r0||c[0]||0,p=c.r1||c[1]||0;i+=d,r+=p,await w("sync-status","\u4ED3\u5E93\u2192"+l.Name,o,0,"success",`\u7981\u7528 ${d} \u542F\u7528 ${p}`)}catch(c){await w("sync-status","\u4ED3\u5E93\u2192"+l.Name,o,0,"failed",String(c))}bus.emit("toast:show",{msg:`\u2705 \u540C\u6B65\u5B8C\u6210\uFF1A\u7981\u7528 ${i} \u9879\uFF0C\u542F\u7528 ${r} \u9879`,duration:3e3,type:"success"}),await reload(t),bus.emit("logs:refresh")}catch(n){await w("sync-status","\u540C\u6B65\u5931\u8D25",repoRoot,0,"failed",String(n)),bus.emit("toast:show",{msg:`\u540C\u6B65\u5931\u8D25: ${String(n)}`,duration:8e3,type:"error"}),bus.emit("logs:refresh")}})),e}class Vt extends HTMLElement{constructor(){super(),this._root=this.attachShadow({mode:"open"}),this._root.adoptedStyleSheets=[new CSSStyleSheet],this._root.adoptedStyleSheets[0].replaceSync(X),this._entries=[],this._search="",this._sort="name",this._dirOpen={},this._repoRoot=""}async connectedCallback(){try{Object.assign(this._dirOpen,JSON.parse(localStorage.getItem("at_dirs")||"{}"))}catch{}this._renderLayout(),pt(this._root,this),this._unsubs=Yt(this),await this._load(),this._renderTree()}disconnectedCallback(){var e;(e=this._unsubs)==null||e.forEach(n=>n==null?void 0:n())}async _load(){try{const e=await qt();e?(this._repoRoot=e.repoRoot,this._entries=e.entries):this._entries=R()}catch{this._entries=R()}}_renderLayout(){this._root.innerHTML=J()+'<div class="list" id="tree"><div class="empty"><div class="big">\u{1F4C1}</div>\u6682\u65E0\u6A21\u578B\u6587\u4EF6</div></div>'+Q()}_renderTree(){const e=this._root.getElementById("tree");ct(e,this._entries,this._search,this._sort,this._dirOpen),dt(e,this),lt(this._root.getElementById("ftr-stat"),this._entries)}}customElements.define("app-tree",Vt);const Ut=`
:host {
