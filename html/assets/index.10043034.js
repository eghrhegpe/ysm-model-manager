...
</div>`}function w(e,t){return`<div class="empty"><div class="big">${e}</div>${t}</div>`}function b(e){return(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function B(e,t){const n=b(e);if(!t)return n;const s=t.toLowerCase(),o=e.toLowerCase().indexOf(s);if(o===-1)return n;const a=b(e.substring(0,o)),r=b(e.substring(o,o+t.length)),i=b(e.substring(o+t.length));return a+"<mark>"+r+"</mark>"+i}function A(e){return!e&&e!==0?"":e<1024?e+" B":e<1048576?(e/1024).toFixed(1)+" KB":(e/1048576).toFixed(1)+" MB"}function I(e){if(!e)return"";const t=new Date(e),n=new Date;return t.toDateString()===n.toDateString()?t.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):(n-t)/864e5<7?["\u65E5","\u4E00","\u4E8C","\u4E09","\u56DB","\u4E94","\u516D"][t.getDay()]+" "+t.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):t.toLocaleDateString([],{month:"short",day:"numeric"})}function P(e){const t=(e.split(".").pop()||"").toLowerCase();return t==="ysm"?"\u{1F48E}":["zip","rar","7z","tar","gz"].includes(t)?"\u{1F4E6}":["png","jpg","jpeg","gif","webp","bmp"].includes(t)?"\u{1F5BC}\uFE0F":["txt","md","json","xml","yml","yaml","cfg","conf","ini"].includes(t)?"\u{1F4C4}":"\u{1F9CA}"}function R(e,t,n){const s=[...e].sort((r,i)=>t==="size"?(i.size||0)-(r.size||0):t==="date"?(i.modTime||0)-(r.modTime||0):r.name.localeCompare(i.name)),o=(n||"").trim().toLowerCase(),a={};return s.forEach(r=>{if(o&&!r.name.toLowerCase().includes(o))return;const i=r.path.replace(/\\/g,"/").split("/");let d=a;for(let c=0;c<i.length-1;c++)!i[c]||(d[i[c]]||(d[i[c]]={}),d=d[i[c]]);d[i[i.length-1]]={_e:r}}),a}function L(e,t){if(!t||!e)return!1;for(const n of Object.keys(e)){const s=e[n];if(s._e){if(s._e.name.toLowerCase().includes(t))return!0}else if(n.toLowerCase().includes(t)||L(s,t))return!0}return!1}function O(e){const t=e.length,n=e.filter(o=>!o.banned).length,s=e.reduce((o,a)=>o+(a.size||0),0);return{total:t,enabled:n,totalSize:s}}function D(e,t,n,s){const o=g(e.path),a=g(e.fullPath||e.path),r=e.banned?"":" on",i=e.banned?"":"\u2713";return`<div class="fl${e.banned?" ban":""}" data-path="${o}" data-fullpath="${a}">
<span class="ck${r}" data-path="${o}" data-fullpath="${a}">${i}</span>
<span class="ficon">${n}</span>
<span class="nm">${t}</span>
<span class="sz">${j(e.size)}</span>${s?`<span class="dt">${s}</span>`:""}</div>`}function F(e,t,n,s){const o=s?"\u{1F512}":"\u{1F4C1}",a=s?"#585b70":"#a6adc8",r=s?" locked":"",i=n?"\u25BC":"\u25B6",d=n?" open":"";return`<div class="fh${r}" data-dir="${g(t)}">
<span class="ar${d}">${i}</span>
<span class="nm" style="color:${a}">${o} ${g(e)}</span></div>
<div class="ch" style="display:${n?"block":"none"}">`}function g(e){return(e||"").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function j(e){return!e&&e!==0?"":e<1024?e+" B":e<1048576?(e/1024).toFixed(1)+" KB":(e/1048576).toFixed(1)+" MB"}function N(e,t,n,s,o){if(!t.length){e.innerHTML=w("\u{1F4C1}","\u6682\u65E0\u6A21\u578B\u6587\u4EF6");return}const a=R(t,s,n),r=T(a,"",n,s,o);if(!r){e.innerHTML=w("\u{1F50D}","\u672A\u627E\u5230\u5339\u914D\u7684\u6587\u4EF6");return}e.innerHTML=r}function q(e,t){if(!e)return;const n=O(t);e.textContent=`\u5171 ${n.total} \u9879 (\u5DF2\u542F\u7528 ${n.enabled}) \xB7 ${A(n.totalSize)}`}function T(e,t,n,s,o){const a=!!(n||"").trim(),r=Object.keys(e).sort((d,c)=>{const u=!e[d]._e,p=!e[c]._e;if(u&&!p)return-1;if(!u&&p)return 1;const f=e[d]._e,l=e[c]._e;return s==="size"?((l==null?void 0:l.size)||0)-((f==null?void 0:f.size)||0):s==="date"?((l==null?void 0:l.modTime)||0)-((f==null?void 0:f.modTime)||0):d.localeCompare(c)});let i="";return r.forEach(d=>{const c=e[d],u=t?t+"/"+d:d;if(c._e){const p=c._e;if(a&&!p.name.toLowerCase().includes(n.toLowerCase()))return;const f=a?B(p.name,n):p.name,l=p.modTime?I(p.modTime):"",y=P(p.name);i+=D(p,f,y,l)}else{const p=d.startsWith("_"),f=a||!!o[u],l=a?L(c,n.toLowerCase()):!1;i+=F(d,u,f||a&&l,p),i+=T(c,u,n,s,o),i+="</div>"}}),i}function m(e){!e||(e.classList.add("flash"),setTimeout(()=>e.classList.remove("flash"),400))}function U(e,t){e.querySelectorAll(".fh").forEach(n=>{n.onclick=s=>{s.stopPropagation();const o=n.nextElementSibling,a=n.querySelector(".ar");if(!o)return;const r=o.style.display!=="none";o.style.display=r?"none":"block",a.classList.toggle("open",!r),t._dirOpen[n.dataset.dir]=!r,localStorage.setItem("at_dirs",JSON.stringify(t._dirOpen))}}),e.querySelectorAll(".ck").forEach(n=>{n.onclick=s=>{s.stopPropagation();const o=n.classList.contains("on");n.classList.toggle("on"),n.textContent=n.classList.contains("on")?"\u2713":"";const a=n.closest(".fl");a&&a.classList.add("flash"),setTimeout(()=>a==null?void 0:a.classList.remove("flash"),400);const r=n.dataset.path,i=n.dataset.fullpath||r;bus.emit("entry:toggle",{path:i,relPath:r,enabled:!o})}}),e.querySelectorAll(".fl").forEach(n=>{n.oncontextmenu=s=>{var i,d,c;s.preventDefault();const o=((d=(i=n.querySelector(".nm"))==null?void 0:i.textContent)==null?void 0:d.replace(/^\S+\s/,""))||"",a=!((c=n.querySelector(".ck"))!=null&&c.classList.contains("on")),r=n.dataset.fullpath||n.dataset.path;bus.emit("ctx:show",{x:s.clientX,y:s.clientY,path:r,relPath:n.dataset.path,name:o,banned:a})}})}function Y(e,t){var o,a,r,i,d,c,u,p,f;const n=l=>e.getElementById(l),s=()=>t._renderTree();(o=n("srch"))==null||o.addEventListener("input",l=>{t._search=l.target.value,s()}),(a=n("sort"))==null||a.addEventListener("change",l=>{t._sort=l.target.value,s()}),(r=n("btn-repo"))==null||r.addEventListener("click",()=>bus.emit("dir:select-repo")),(i=n("btn-dedup"))==null||i.addEventListener("click",()=>bus.emit("entries:dedup")),(d=n("btn-trash"))==null||d.addEventListener("click",()=>bus.emit("recycle:open")),(c=n("btn-pv"))==null||c.addEventListener("click",()=>bus.emit("preview:toggle")),(u=n("btn-ea"))==null||u.addEventListener("click",()=>{m(n("btn-ea")),t._entries.forEach(l=>{l.banned=!1}),s()}),(p=n("btn-da"))==null||p.addEventListener("click",()=>{m(n("btn-da")),t._entries.forEach(l=>{l.banned=!0}),s()}),(f=n("btn-st"))==null||f.addEventListener("click",()=>m(n("btn-st")))}function J(e){return window.go.main.App.IsFileBanned(e)}function K(){return window.go.main.App.LoadAppConfig()}function W(e,t,n){return window.go.main.App.SaveAppConfig(e,t,n)}function G(e){return window.go.main.App.ScanModelEntries(e)}function V(){return window.go.main.App.SelectDirectory()}function X(e){return window.go.main.App.ToggleModelEnable(e)}async function E(){const e=await K();console.log("[app-tree] LoadAppConfig:",JSON.stringify(e));const t=e.repoRoot||e.RepoRoot||"";if(!t)return console.warn("[app-tree] RepoRoot \u4E3A\u7A7A\uFF0C\u8D70\u964D\u7EA7"),null;const n=await G(t);if(console.log("[app-tree] ScanModelEntries \u8FD4\u56DE:",n==null?void 0:n.length,"\u4E2A\u6587\u4EF6"),!n||!n.length)return console.warn("[app-tree] \u626B\u63CF\u65E0\u7ED3\u679C\uFF0C\u8D70\u964D\u7EA7"),null;const s=[];for(const o of n){let a=!1;try{a=await J(o.Path)}catch{}let r=o.Path;t&&o.Path.startsWith(t)&&(r=o.Path.slice(t.length).replace(/^[/\\]+/,"")),s.push({name:o.Name,path:r,fullPath:o.Path,size:o.Size,modTime:o.ModTime,banned:a})}return console.log("[app-tree] \u5904\u7406\u540E entries:",s.length,"\u4E2A"),{repoRoot:t,entries:s}}function h(){const e=Date.now();return[{name:"steve_skin.ysm",path:"steve_skin.ysm",size:1258291,modTime:e-864e5,banned:!1},{name:"alex_deluxe.ysm",path:"alex/alex_deluxe.ysm",size:2516582,modTime:e-1728e5,banned:!1},{name:"alex_head.ysm",path:"alex/alex_head.ysm",size:524288,modTime:e-1728e5,banned:!1},{name:"dragon_armor.zip",path:"dragon/dragon_armor.zip",size:3984588,modTime:e-36e5,banned:!1},{name:"dragon_wings.ysm",path:"dragon/dragon_wings.ysm",size:2202009,modTime:e-72e5,banned:!1},{name:"neon_sword.ysm",path:"weapons/neon_sword.ysm",size:1572864,modTime:e,banned:!1},{name:"magic_staff.zip",path:"weapons/magic_staff.zip",size:4404019,modTime:e-72e5,banned:!1},{name:"photon_body.ysm",path:"photon/photon_body.ysm",size:2202009,modTime:e-432e5,banned:!1},{name:"old_model.ysm",path:"_disabled/old_model.ysm",size:943718,modTime:e-6048e5,banned:!0},{name:"custom_hat.ysm",path:"custom/custom_hat.ysm",size:838860,modTime:e-2592e5,banned:!1},{name:"steve_2d.ysm",path:"custom/steve_2d.ysm",size:314572,modTime:e-5e5,banned:!1}]}function Q(e){const t=[];return t.push(bus.on("entry:toggle",async({path:n})=>{try{await X(n)}catch{}await _(e)})),t.push(bus.on("dir:select-repo",async()=>{try{const n=await V();if(console.log("[app-tree] SelectDirectory \u8FD4\u56DE:",n),!n)return;await W(n,"","copy"),console.log("[app-tree] SaveAppConfig \u5B8C\u6210, dir:",n),e._repoRoot=n,await _(e)}catch(n){console.error("[app-tree] \u9009\u62E9\u4ED3\u5E93\u76EE\u5F55\u5931\u8D25:",n),e._entries=h(),e._renderTree()}})),t.push(bus.on("entries:dedup",()=>{bus.emit("toast:show",{msg:"\u{1F517} \u53BB\u91CD\u529F\u80FD\u5F00\u53D1\u4E2D",duration:2e3,type:"info"})})),t.push(bus.on("recycle:open",()=>{bus.emit("toast:show",{msg:"\u{1F5D1}\uFE0F \u56DE\u6536\u7AD9\u529F\u80FD\u5F00\u53D1\u4E2D",duration:2e3,type:"info"})})),t}async function _(e){try{const t=await E();t?(e._repoRoot=t.repoRoot,e._entries=t.entries,console.log("[app-tree] reload \u6210\u529F:",t.entries.length,"\u4E2A\u6587\u4EF6")):(console.warn("[app-tree] reload \u8FD4\u56DE null"),e._entries=h())}catch(t){console.error("[app-tree] reload \u5F02\u5E38:",t),e._entries=h()}e._renderTree()}class Z extends HTMLElement{constructor(){super(),this._root=this.attachShadow({mode:"open"}),this._root.adoptedStyleSheets=[new CSSStyleSheet],this._root.adoptedStyleSheets[0].replaceSync(M),this._entries=[],this._search="",this._sort="name",this._dirOpen={},this._repoRoot=""}async connectedCallback(){try{Object.assign(this._dirOpen,JSON.parse(localStorage.getItem("at_dirs")||"{}"))}catch{}this._renderLayout(),Y(this._root,this),this._unsubs=Q(this),await this._load(),this._renderTree()}disconnectedCallback(){var t;(t=this._unsubs)==null||t.forEach(n=>n==null?void 0:n())}async _load(){try{const t=await E();t?(this._repoRoot=t.repoRoot,this._entries=t.entries,console.log("[app-tree] \u52A0\u8F7D\u6210\u529F:",t.entries.length,"\u4E2A\u6587\u4EF6, repoRoot:",t.repoRoot)):(console.warn("[app-tree] loadEntries \u8FD4\u56DE null\uFF0C\u8D70\u964D\u7EA7"),this._entries=h())}catch(t){console.error("[app-tree] loadEntries \u5F02\u5E38:",t),this._entries=h()}}_renderLayout(){this._root.innerHTML=$()+'<div class="list" id="tree"><div class="empty"><div class="big">\u{1F4C1}</div>\u6682\u65E0\u6A21\u578B\u6587\u4EF6</div></div>'+H()}_renderTree(){const t=this._root.getElementById("tree");N(t,this._entries,this._search,this._sort,this._dirOpen),U(t,this),q(this._root.getElementById("ftr-stat"),this._entries)}}customElements.define("app-tree",Z);const ee=`
:host {
