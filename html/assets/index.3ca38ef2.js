...
</div>`}function tt(){return`<div class="ftr">
...
</div>`}function F(t,e){return`<div class="empty"><div class="big">${t}</div>${e}</div>`}function _(t){return(t||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function et(t,e){const s=_(t);if(!e)return s;const o=e.toLowerCase(),n=t.toLowerCase().indexOf(o);if(n===-1)return s;const a=_(t.substring(0,n)),i=_(t.substring(n,n+e.length)),r=_(t.substring(n+e.length));return a+"<mark>"+i+"</mark>"+r}function st(t){return!t&&t!==0?"":t<1024?t+" B":t<1048576?(t/1024).toFixed(1)+" KB":(t/1048576).toFixed(1)+" MB"}function nt(t){if(!t)return"";const e=new Date(t),s=new Date;return e.toDateString()===s.toDateString()?e.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):(s-e)/864e5<7?["\u65E5","\u4E00","\u4E8C","\u4E09","\u56DB","\u4E94","\u516D"][e.getDay()]+" "+e.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):e.toLocaleDateString([],{month:"short",day:"numeric"})}function ot(t){const e=(t.split(".").pop()||"").toLowerCase();return e==="ysm"?"\u{1F48E}":["zip","rar","7z","tar","gz"].includes(e)?"\u{1F4E6}":["png","jpg","jpeg","gif","webp","bmp"].includes(e)?"\u{1F5BC}\uFE0F":["txt","md","json","xml","yml","yaml","cfg","conf","ini"].includes(e)?"\u{1F4C4}":"\u{1F9CA}"}function at(t,e,s,o){const n=k(t.path),a=k(t.fullPath||t.path),i=t.banned?"":" on",r=t.banned?"":"\u2713";return`<div class="fl${t.banned?" ban":""}" data-path="${n}" data-fullpath="${a}">
<span class="ck${i}" data-path="${n}" data-fullpath="${a}">${r}</span>
<span class="ficon">${s}</span>
<span class="nm">${e}</span>
<span class="sz">${rt(t.size)}</span>${o?`<span class="dt">${o}</span>`:""}</div>`}function it(t,e,s,o){const n=o?"\u{1F512}":"\u{1F4C1}",a=o?"#585b70":"#a6adc8",i=o?" locked":"",r=s?"\u25BC":"\u25B6",c=s?" open":"";return`<div class="fh${i}" data-dir="${k(e)}">
<span class="ar${c}">${r}</span>
<span class="nm" style="color:${a}">${n} ${k(t)}</span></div>
<div class="ch" style="display:${s?"block":"none"}">`}function k(t){return(t||"").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function rt(t){return!t&&t!==0?"":t<1024?t+" B":t<1048576?(t/1024).toFixed(1)+" KB":(t/1048576).toFixed(1)+" MB"}function ct(t,e,s){const o={},n=(s||"").trim().toLowerCase();return[...t].sort((i,r)=>{if(e==="name")return i.name.localeCompare(r.name);if(e==="size"){const c=i.size||0;return(r.size||0)-c}if(e==="date"){const c=i.modTime||0;return(r.modTime||0)-c}return 0}).forEach(i=>{if(!i||!i.path)return;const r=i.path;if(n&&!r.toLowerCase().includes(n))return;const c=r.replace(/\\/g,"/").split("/");let l=o;for(let d=0;d<c.length-1;d++)!c[d]||(l[c[d]]||(l[c[d]]={}),l=l[c[d]]);const p=c[c.length-1];p&&(l[p]={_e:i})}),o}function Y(t,e,s,o,n){const a=!!(s||"").trim(),i=Object.keys(t).sort((c,l)=>{const p=!t[c]._e,d=!t[l]._e;if(p&&!d)return-1;if(!p&&d)return 1;const u=t[c]._e,f=t[l]._e;return o==="size"?((f==null?void 0:f.size)||0)-((u==null?void 0:u.size)||0):o==="date"?((f==null?void 0:f.modTime)||0)-((u==null?void 0:u.modTime)||0):c.localeCompare(l)});let r="";return i.forEach(c=>{const l=t[c],p=e?e+"/"+c:c;if(l._e){const d=l._e;if(a&&!d.name.toLowerCase().includes(s.toLowerCase()))return;const u=a?et(d.name,s):d.name,f=d.modTime?nt(d.modTime):"";r+=at(d,u,ot(d.name),f)}else{const d=c.startsWith("_"),u=a||!!n[p];r+=it(c,p,u,d),r+=Y(l,p,s,o,n),r+="</div>"}}),r}function lt(t,e,s,o,n){if(!e.length){t.innerHTML=F("\u{1F4C1}","\u6682\u65E0\u6A21\u578B\u6587\u4EF6");return}const a=ct(e,o,s),i=Y(a,"",s,o,n);if(!i){t.innerHTML=F("\u{1F50D}","\u672A\u627E\u5230\u5339\u914D\u7684\u6587\u4EF6");return}t.innerHTML=i}function dt(t,e){if(!t)return;let s=0,o=0,n=0;e.forEach(a=>{s++,a.banned||o++,n+=a.size||0}),t.textContent=`\u5171 ${s} \u9879 (\u5DF2\u542F\u7528 ${o}) \xB7 ${st(n)}`}function O(t){!t||(t.classList.add("flash"),setTimeout(()=>t.classList.remove("flash"),400))}function I(t,e,s,o,n,a){return window.go.main.App.AddImportLog(t,e,s,o,n,a)}function U(t){return window.go.main.App.AnalyzeYSMModel(t)}function pt(t){return window.go.main.App.CheckFileExists(t)}function ut(t){return window.go.main.App.ClearCustomDir(t)}function ft(){return window.go.main.App.ClearImportLogs()}function gt(t){return window.go.main.App.CountLinkedModels(t)}function mt(t){return window.go.main.App.CreateDir(t)}function ht(t){return window.go.main.App.DeduplicateCustomDir(t)}function bt(t){return window.go.main.App.DeleteFromRecycle(t)}function xt(t){return window.go.main.App.EmptyRecycleBin(t)}function vt(t){return window.go.main.App.GetGlobalCustomDir(t)}function yt(){return window.go.main.App.GetImportLogs()}function W(t,e){return window.go.main.App.GetInstanceStatus(t,e)}function wt(){return window.go.main.App.GetLinkMode()}function _t(){return window.go.main.App.GetMinecraftPath()}function kt(){return window.go.main.App.GetWindowPosition()}function St(t){return window.go.main.App.HasYSMMod(t)}function Lt(t,e){return window.go.main.App.ImportModelFile(t,e)}function Et(t,e){return window.go.main.App.InstallModelFile(t,e)}function Tt(t,e){return window.go.main.App.InstallModelTo(t,e)}function Mt(t,e){return window.go.main.App.InstallModelWithOverlay(t,e)}function K(t){return window.go.main.App.IsFileBanned(t)}function zt(t){return window.go.main.App.IsSymlink(t)}function Ct(t){return window.go.main.App.ListFileNames(t)}function $t(t){return window.go.main.App.ListRecycleBin(t)}function D(t){return window.go.main.App.ListVersionInstances(t)}function y(){return window.go.main.App.LoadAppConfig()}function Rt(t,e){return window.go.main.App.MoveModelFile(t,e)}function At(t){return window.go.main.App.MoveToRecycle(t)}function It(t){return window.go.main.App.MoveToRecycleEx(t)}function Dt(t){return window.go.main.App.OpenFolder(t)}function Ht(t,e){return window.go.main.App.RestoreFromRecycle(t,e)}function H(t,e,s){return window.go.main.App.SaveAppConfig(t,e,s)}function Pt(t,e,s,o){return window.go.main.App.SaveWindowPosition(t,e,s,o)}function Bt(t){return window.go.main.App.ScanCustomModels(t)}function P(t){return window.go.main.App.ScanModelEntries(t)}function B(){return window.go.main.App.SelectDirectory()}function Ft(t){return window.go.main.App.SetLinkMode(t)}function Ot(t){return window.go.main.App.SetRepoRoot(t)}function jt(t,e){return window.go.main.App.SyncCustomToRepo(t,e)}function Gt(t,e){return window.go.main.App.SyncModelToggleStatus(t,e)}function w(t){return window.go.main.App.ToggleModelEnable(t)}const h=Object.freeze(Object.defineProperty({__proto__:null,AddImportLog:I,AnalyzeYSMModel:U,CheckFileExists:pt,ClearCustomDir:ut,ClearImportLogs:ft,CountLinkedModels:gt,CreateDir:mt,DeduplicateCustomDir:ht,DeleteFromRecycle:bt,EmptyRecycleBin:xt,GetGlobalCustomDir:vt,GetImportLogs:yt,GetInstanceStatus:W,GetLinkMode:wt,GetMinecraftPath:_t,GetWindowPosition:kt,HasYSMMod:St,ImportModelFile:Lt,InstallModelFile:Et,InstallModelTo:Tt,InstallModelWithOverlay:Mt,IsFileBanned:K,IsSymlink:zt,ListFileNames:Ct,ListRecycleBin:$t,ListVersionInstances:D,LoadAppConfig:y,MoveModelFile:Rt,MoveToRecycle:At,MoveToRecycleEx:It,OpenFolder:Dt,RestoreFromRecycle:Ht,SaveAppConfig:H,SaveWindowPosition:Pt,ScanCustomModels:Bt,ScanModelEntries:P,SelectDirectory:B,SetLinkMode:Ft,SetRepoRoot:Ot,SyncCustomToRepo:jt,SyncModelToggleStatus:Gt,ToggleModelEnable:w},Symbol.toStringTag,{value:"Module"}));function Nt(t,e){t.querySelectorAll(".fh").forEach(s=>{s.onclick=o=>{o.stopPropagation();const n=s.nextElementSibling,a=s.querySelector(".ar");if(!n)return;const i=n.style.display!=="none";n.style.display=i?"none":"block",a.classList.toggle("open",!i),e._dirOpen[s.dataset.dir]=!i,localStorage.setItem("at_dirs",JSON.stringify(e._dirOpen))}}),t.querySelectorAll(".ck").forEach(s=>{s.onclick=async o=>{o.stopPropagation(),s.classList.contains("on"),s.classList.toggle("on"),s.textContent=s.classList.contains("on")?"\u2713":"";const n=s.closest(".fl");n&&n.classList.add("flash"),setTimeout(()=>n==null?void 0:n.classList.remove("flash"),400);const a=s.dataset.fullpath||s.dataset.path;try{await w(a),await e._load(),e._renderTree(),bus.emit("stats:refresh")}catch{s.classList.toggle("on"),s.textContent=s.classList.contains("on")?"\u2713":""}}}),t.querySelectorAll(".fh").forEach(s=>{s.oncontextmenu=o=>{o.preventDefault(),o.stopPropagation(),bus.emit("ctx:show",{x:o.clientX,y:o.clientY,type:"dir",dir:s.dataset.dir})}}),t.querySelectorAll(".fl").forEach(s=>{s.oncontextmenu=o=>{var c,l;o.preventDefault(),o.stopPropagation();const n=!((c=s.querySelector(".ck"))!=null&&c.classList.contains("on")),a=s.dataset.fullpath||s.dataset.path,i=s.querySelector(".nm"),r=((l=i==null?void 0:i.textContent)==null?void 0:l.replace(/^\S+\s/,""))||"";bus.emit("ctx:show",{x:o.clientX,y:o.clientY,type:"file",path:a,banned:n,name:r})}})}function qt(t,e){var n,a,i,r,c,l,p,d,u;const s=f=>t.getElementById(f),o=()=>e._renderTree();(n=s("srch"))==null||n.addEventListener("input",f=>{e._search=f.target.value,o()}),(a=s("sort"))==null||a.addEventListener("change",f=>{e._sort=f.target.value,o()}),(i=s("btn-repo"))==null||i.addEventListener("click",()=>bus.emit("dir:select-repo")),(r=s("btn-dedup"))==null||r.addEventListener("click",()=>bus.emit("entries:dedup")),(c=s("btn-trash"))==null||c.addEventListener("click",()=>bus.emit("recycle:open")),(l=s("btn-pv"))==null||l.addEventListener("click",()=>bus.emit("preview:toggle")),(p=s("btn-ea"))==null||p.addEventListener("click",()=>{O(s("btn-ea")),e._entries.forEach(f=>{f.banned=!1}),o()}),(d=s("btn-da"))==null||d.addEventListener("click",()=>{O(s("btn-da")),e._entries.forEach(f=>{f.banned=!0}),o()}),(u=s("btn-st"))==null||u.addEventListener("click",()=>{bus.emit("sync:toggle-status")})}async function X(){const t=await y(),e=t.repoRoot||t.RepoRoot||"";if(!e)return null;const s=await P(e);if(!s||!s.length)return null;const o=[];for(const n of s){let a=!1;try{a=await K(n.Path)}catch{}let i=n.Path;e&&n.Path.startsWith(e)&&(i=n.Path.slice(e.length).replace(/^[/\\]+/,"")),o.push({name:n.Name,path:i,fullPath:n.Path,size:n.Size,modTime:n.ModTime,banned:a})}return{repoRoot:e,entries:o}}function v(){const t=Date.now();return[{name:"steve_skin.ysm",path:"steve_skin.ysm",size:1258291,modTime:t-864e5,banned:!1},{name:"alex_deluxe.ysm",path:"alex/alex_deluxe.ysm",size:2516582,modTime:t-1728e5,banned:!1},{name:"alex_head.ysm",path:"alex/alex_head.ysm",size:524288,modTime:t-1728e5,banned:!1},{name:"dragon_armor.zip",path:"dragon/dragon_armor.zip",size:3984588,modTime:t-36e5,banned:!1},{name:"dragon_wings.ysm",path:"dragon/dragon_wings.ysm",size:2202009,modTime:t-72e5,banned:!1},{name:"neon_sword.ysm",path:"weapons/neon_sword.ysm",size:1572864,modTime:t,banned:!1},{name:"magic_staff.zip",path:"weapons/magic_staff.zip",size:4404019,modTime:t-72e5,banned:!1},{name:"photon_body.ysm",path:"photon/photon_body.ysm",size:2202009,modTime:t-432e5,banned:!1},{name:"old_model.ysm",path:"_disabled/old_model.ysm",size:943718,modTime:t-6048e5,banned:!0},{name:"custom_hat.ysm",path:"custom/custom_hat.ysm",size:838860,modTime:t-2592e5,banned:!1},{name:"steve_2d.ysm",path:"custom/steve_2d.ysm",size:314572,modTime:t-5e5,banned:!1}]}const Vt="modulepreload",Yt=function(t){return"/"+t},j={},b=function(e,s,o){if(!s||s.length===0)return e();const n=document.getElementsByTagName("link");return Promise.all(s.map(a=>{if(a=Yt(a),a in j)return;j[a]=!0;const i=a.endsWith(".css"),r=i?'[rel="stylesheet"]':"";if(!!o)for(let p=n.length-1;p>=0;p--){const d=n[p];if(d.href===a&&(!i||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${a}"]${r}`))return;const l=document.createElement("link");if(l.rel=i?"stylesheet":Vt,i||(l.as="script",l.crossOrigin=""),l.href=a,document.head.appendChild(l),i)return new Promise((p,d)=>{l.addEventListener("load",p),l.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${a}`)))})})).then(()=>e())};function Ut(t){const e=[];return e.push(bus.on("entry:toggle",async({path:s})=>{try{await w(s)}catch{}await L(t),bus.emit("stats:refresh")})),e.push(bus.on("dir:select-repo",async()=>{try{const s=await B();if(!s)return;await H(s,"","copy"),t._repoRoot=s,await L(t),bus.emit("stats:refresh")}catch{t._entries=v(),t._renderTree()}})),e.push(bus.on("entries:dedup",()=>{bus.emit("toast:show",{msg:"\u{1F517} \u53BB\u91CD\u529F\u80FD\u5F00\u53D1\u4E2D",duration:2e3,type:"info"})})),e.push(bus.on("recycle:open",()=>{bus.emit("toast:show",{msg:"\u{1F5D1}\uFE0F \u56DE\u6536\u7AD9\u529F\u80FD\u5F00\u53D1\u4E2D",duration:2e3,type:"info"})})),e.push(bus.on("batch:enable",({dir:s})=>{G(t,s,!0)})),e.push(bus.on("batch:disable",({dir:s})=>{G(t,s,!1)})),e.push(bus.on("sync:toggle-status",async()=>{try{const s=await y(),o=s.repoRoot||s.RepoRoot||"",n=s.mcRoot||s.McRoot||"";if(!o||!n){bus.emit("toast:show",{msg:"\u8BF7\u5148\u914D\u7F6E\u6E38\u620F\u76EE\u5F55\u548C\u4ED3\u5E93\u76EE\u5F55",duration:3e3,type:"warn"});return}const a=await D(n);if(!a||!a.length){bus.emit("toast:show",{msg:"\u6CA1\u6709\u627E\u5230\u6574\u5408\u5305",duration:2e3,type:"info"});return}let i=0,r=0;const c=[];for(const l of a)if(!!l.Exists)try{const{SyncModelToggleStatus:p}=await b(()=>Promise.resolve().then(()=>h),void 0),d=await p(l.CustomDir,o),u=d&&(d.r0||d[0])||0,f=d&&(d.r1||d[1])||0;(u>0||f>0)&&(i+=u,r+=f)}catch(p){c.push(`${l.Name}: ${String(p)}`)}await I("sync-status","\u540C\u6B65\u72B6\u6001 ("+a.filter(l=>l.Exists).length+" \u4E2A\u6574\u5408\u5305)",o,0,c.length?"failed":"success","\u7981\u7528 "+i+" \u542F\u7528 "+r+(c.length?" | \u9519\u8BEF: "+c.join("; "):"")),bus.emit("toast:show",{msg:`\u2705 \u540C\u6B65\u5B8C\u6210\uFF1A\u7981\u7528 ${i} \u9879\uFF0C\u542F\u7528 ${r} \u9879`,duration:3e3,type:"success"}),await L(t),bus.emit("stats:refresh"),bus.emit("logs:refresh")}catch(s){await I("sync-status","\u540C\u6B65\u5931\u8D25",repoRoot||"",0,"failed",String(s)),bus.emit("toast:show",{msg:`\u540C\u6B65\u5931\u8D25: ${String(s)}`,duration:8e3,type:"error"}),bus.emit("logs:refresh")}})),e}async function L(t){try{const e=await X();e?(t._repoRoot=e.repoRoot,t._entries=e.entries):t._entries=v()}catch{t._entries=v()}t._renderTree()}async function G(t,e,s){const o=e.replace(/\\/g,"/"),n=t._entries.filter(r=>r.path&&r.path.startsWith(o));if(!n.length)return;let a=0,i=0;for(const r of n)if(r.banned!==!s)try{await w(r.fullPath),r.banned=!s,a++}catch{i++}a>0&&(t._renderTree(),bus.emit("stats:refresh")),bus.emit("toast:show",{msg:`\u6279\u91CF${s?"\u542F\u7528":"\u7981\u7528"}: ${a} \u6210\u529F, ${i} \u5931\u8D25`,duration:3e3,type:i>0?"warn":"success"})}class Wt extends HTMLElement{constructor(){super(),this._root=this.attachShadow({mode:"open"}),this._root.adoptedStyleSheets=[new CSSStyleSheet],this._root.adoptedStyleSheets[0].replaceSync(Q),this._entries=[],this._search="",this._sort="name",this._dirOpen={},this._repoRoot=""}async connectedCallback(){try{Object.assign(this._dirOpen,JSON.parse(localStorage.getItem("at_dirs")||"{}"))}catch{}this._renderLayout(),qt(this._root,this),this._unsubs=Ut(this),await this._load(),this._renderTree()}disconnectedCallback(){var e;(e=this._unsubs)==null||e.forEach(s=>s==null?void 0:s())}async _load(){try{const e=await X();e?(this._repoRoot=e.repoRoot,this._entries=e.entries):this._entries=v()}catch{this._entries=v()}}_renderLayout(){this._root.innerHTML=Z()+'<div class="list" id="tree"><div class="empty"><div class="big">\u{1F4C1}</div>\u6682\u65E0\u6A21\u578B\u6587\u4EF6</div></div>'+tt()}_renderTree(){const e=this._root.getElementById("tree");lt(e,this._entries,this._search,this._sort,this._dirOpen),Nt(e,this),dt(this._root.getElementById("ftr-stat"),this._entries)}}customElements.define("app-tree",Wt);const Kt=`
:host {
...
`;function Xt(){return`<div class="header">
...
</div>`}function Jt(){return`<div class="footer">
<button class="footer-btn" id="btn-mc">\u{1F3AE} \u6307\u5B9A\u6E38\u620F\u8DEF\u5F84</button>
</div>`}function Qt(){return'<div class="list" id="vg"></div>'}function Zt(t,e,s,o,n=!1){let a="";o==="complete"?a='<span class="tag green">\u2705</span>':o==="extra"?a='<span class="tag orange">\u{1F4E4}</span>':o==="missing"&&(a='<span class="tag red">\u2B07\uFE0F</span>');const i=[];return e>0&&i.push(`<span class="tag green">\u2705 ${e}</span>`),s>0&&i.push(`<span class="tag red">\u2B07\uFE0F ${s}</span>`),`<div class="vc-header">
<span class="${n?"arrow open":"arrow"}">\u25B6</span>
${a}
<span class="name">\u{1F4E6} ${J(t)}</span>
${i.join("")}
</div>`}function E(t,e){return`<div class="sec-title">${t} (${e})</div>`}function T(t,e,s,o){const n=o?`<span class="link-icon">${o}</span>`:"";return`<div class="row"><span class="dot" style="background:${t}"></span><span class="rn">${J(e)}</span>${n}<span class="sz">${s}</span></div>`}function J(t){return(t||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function te(t,e){t.innerHTML="",e.forEach((s,o)=>{const n=document.createElement("div");n.className="vc",n.dataset.idx=o;const a=o===0;n.innerHTML=Zt(s.name,s.synced,s.missing,s.status,a),t.appendChild(n);const i=document.createElement("div");i.className="vc-body",i.style.display=a?"":"none",i.innerHTML=ee(s),t.appendChild(i)})}function ee(t){let e="";return t.items.synced.length&&(e+=E("\u2705 \u5DF2\u540C\u6B65",t.items.synced.length),t.items.synced.forEach(s=>{e+=T("#a6e3a1",s.name,s.size,s.linkType)})),t.items.missing.length&&(e+=E("\u2B07\uFE0F \u7F3A\u5931",t.items.missing.length),t.items.missing.forEach(s=>{e+=T("#f38ba8",s.name,s.size,"")})),t.items.extra.length&&(e+=E("\u{1F4E4} \u989D\u5916",t.items.extra.length),t.items.extra.forEach(s=>{e+=T("#f9a826",s.name,s.size,"")})),e}function se(t){t.querySelectorAll(".vc-context-menu").forEach(e=>e.remove()),t.querySelectorAll(".vc").forEach(e=>{const s=e.querySelector(".vc-header"),o=e.nextElementSibling;!s||!o||!o.classList.contains("vc-body")||(s.onclick=()=>{const n=s.querySelector(".arrow");o.style.display=o.style.display==="none"?"":"none",n&&n.classList.toggle("open")},s.oncontextmenu=n=>{n.preventDefault(),n.stopPropagation();const a=s.querySelector(".name"),i=a?a.textContent.replace(/^📦\s*/,""):"";bus.emit("ctx:show",{x:n.clientX,y:n.clientY,type:"instance",instanceName:i})})})}function ne(t,e){const s=t.getElementById("ver-search");s&&(s.oninput=o=>{const n=o.target.value.toLowerCase().trim();e._search=n,e._renderCards()})}function oe(t){const e=t.getElementById("btn-mc");e&&(e.onclick=()=>bus.emit("dir:select-mc"))}async function ae(){bus.emit("loading:start");try{const t=await y(),e=t.mcRoot||t.McRoot||"",s=t.repoRoot||t.RepoRoot||"";if(!e||!s)return null;const o=await P(s),n=new Set;o.forEach(l=>n.add(l.Name.replace(/\.ban$/i,"")));const a=await D(e);if(!a||!a.length)return null;const i=await W(e,s),r={};return(i||[]).forEach(l=>{r[l.Name]=l}),a.map(l=>{const p=r[l.Name]||{},d=p.Missing||[],u=p.Extra||[],f=new Set(d.map(g=>g.replace(/\.ban$/i,""))),m=new Set(u.map(g=>g.replace(/\.ban$/i,""))),S=[];return n.forEach(g=>{!f.has(g)&&!m.has(g)&&S.push(g)}),{name:l.Name,exists:l.Exists,hasYSM:p.HasYSM,status:p.Status||"missing",synced:S.length,missing:d.length,extra:u.length,items:{synced:S.slice(0,20).map(g=>{const x=M(g,p.Files);return{name:g,size:"",linkType:x}}),missing:d.slice(0,20).map(g=>{const x=M(g,p.Files);return{name:g,size:"",linkType:x}}),extra:u.slice(0,20).map(g=>{const x=M(g,p.Files);return{name:g,size:"",linkType:x}})}}})}finally{bus.emit("loading:end")}}function M(t,e){if(!e||!e.length)return"";const s=e.find(o=>o.Name===t);return s?s.LinkType==="symlink"||s.LinkType==="hardlink"?"\u{1F517}":"\u{1F4CB}":""}function N(){return[{name:"\u6211\u7684\u6574\u5408\u5305",synced:3,missing:1,extra:2,items:{synced:[{name:"steve_skin.ysm",size:"1.2 MB"},{name:"alex_deluxe.ysm",size:"2.4 MB"},{name:"neon_sword.ysm",size:"1.5 MB"}],missing:[{name:"dragon_armor.zip",size:"3.8 MB"}],extra:[{name:"custom_hat.ysm",size:"0.8 MB"},{name:"old_hat.ysm",size:"0.3 MB"}]}},{name:"\u5149\u5F71\u6D4B\u8BD5\u5305",synced:1,missing:2,extra:0,items:{synced:[],missing:[],extra:[]}},{name:"\u7A7A\u5C9B\u751F\u5B58",synced:5,missing:0,extra:0,items:{synced:[],missing:[],extra:[]}},{name:"RPG \u5192\u9669",synced:2,missing:3,extra:0,items:{synced:[],missing:[],extra:[]}}]}class ie extends HTMLElement{constructor(){super(),this._root=this.attachShadow({mode:"open"}),this._root.adoptedStyleSheets=[new CSSStyleSheet],this._root.adoptedStyleSheets[0].replaceSync(Kt),this._instances=[],this._unsubs=[],this._search=""}async connectedCallback(){this._renderLayout(),this._unsubs.push(bus.on("dir:select-mc",async()=>{try{const e=await B();if(!e)return;const s=await y();await H(s.repoRoot||"",e,s.linkMode||"copy")}catch{}await this._reload()})),this._unsubs.push(bus.on("stats:refresh",async()=>{await this._reload()})),await this._reload()}_renderCards(){const e=this._root.getElementById("vg");if(!e)return;const s=this._search,o=s?this._instances.filter(n=>n.name.toLowerCase().includes(s)):this._instances;te(e,o),se(this._root)}async _reload(){try{const s=await ae();s?this._instances=s:this._instances=N()}catch{this._instances=N()}const e=this._root.getElementById("ver-stat");e&&(e.textContent=`${this._instances.length}\u4E2A\u6574\u5408\u5305`),this._renderCards(),ne(this._root,this),oe(this._root)}disconnectedCallback(){this._unsubs.forEach(e=>e())}_renderLayout(){this._root.innerHTML=Xt()+Qt()+Jt()}}customElements.define("app-sidebar",ie);const re=`
:host {
  display: flex; flex-direction: column;
  background: #11111b;
