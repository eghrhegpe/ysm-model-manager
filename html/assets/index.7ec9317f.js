...
</div>`}function X(){return`<div class="ftr">
...
</div>`}function I(e,t){return`<div class="empty"><div class="big">${e}</div>${t}</div>`}function b(e){return(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Q(e,t){const n=b(e);if(!t)return n;const o=t.toLowerCase(),s=e.toLowerCase().indexOf(o);if(s===-1)return n;const a=b(e.substring(0,s)),i=b(e.substring(s,s+t.length)),r=b(e.substring(s+t.length));return a+"<mark>"+i+"</mark>"+r}function Z(e){return!e&&e!==0?"":e<1024?e+" B":e<1048576?(e/1024).toFixed(1)+" KB":(e/1048576).toFixed(1)+" MB"}function ee(e){if(!e)return"";const t=new Date(e),n=new Date;return t.toDateString()===n.toDateString()?t.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):(n-t)/864e5<7?["\u65E5","\u4E00","\u4E8C","\u4E09","\u56DB","\u4E94","\u516D"][t.getDay()]+" "+t.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):t.toLocaleDateString([],{month:"short",day:"numeric"})}function te(e){const t=(e.split(".").pop()||"").toLowerCase();return t==="ysm"?"\u{1F48E}":["zip","rar","7z","tar","gz"].includes(t)?"\u{1F4E6}":["png","jpg","jpeg","gif","webp","bmp"].includes(t)?"\u{1F5BC}\uFE0F":["txt","md","json","xml","yml","yaml","cfg","conf","ini"].includes(t)?"\u{1F4C4}":"\u{1F9CA}"}function ne(e,t,n){const o=[...e].sort((i,r)=>t==="size"?(r.size||0)-(i.size||0):t==="date"?(r.modTime||0)-(i.modTime||0):i.name.localeCompare(r.name)),s=(n||"").trim().toLowerCase(),a={};return o.forEach(i=>{if(s&&!i.name.toLowerCase().includes(s))return;const r=i.path.replace(/\\/g,"/").split("/");let d=a;for(let c=0;c<r.length-1;c++)!r[c]||(d[r[c]]||(d[r[c]]={}),d=d[r[c]]);d[r[r.length-1]]={_e:i}}),a}function G(e,t){if(!t||!e)return!1;for(const n of Object.keys(e)){const o=e[n];if(o._e){if(o._e.name.toLowerCase().includes(t))return!0}else if(n.toLowerCase().includes(t)||G(o,t))return!0}return!1}function se(e){const t=e.length,n=e.filter(s=>!s.banned).length,o=e.reduce((s,a)=>s+(a.size||0),0);return{total:t,enabled:n,totalSize:o}}function oe(e,t,n,o){const s=x(e.path),a=x(e.fullPath||e.path),i=e.banned?"":" on",r=e.banned?"":"\u2713";return`<div class="fl${e.banned?" ban":""}" data-path="${s}" data-fullpath="${a}">
<span class="ck${i}" data-path="${s}" data-fullpath="${a}">${r}</span>
<span class="ficon">${n}</span>
<span class="nm">${t}</span>
<span class="sz">${ie(e.size)}</span>${o?`<span class="dt">${o}</span>`:""}</div>`}function ae(e,t,n,o){const s=o?"\u{1F512}":"\u{1F4C1}",a=o?"#585b70":"#a6adc8",i=o?" locked":"",r=n?"\u25BC":"\u25B6",d=n?" open":"";return`<div class="fh${i}" data-dir="${x(t)}">
<span class="ar${d}">${r}</span>
<span class="nm" style="color:${a}">${s} ${x(e)}</span></div>
<div class="ch" style="display:${n?"block":"none"}">`}function x(e){return(e||"").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function ie(e){return!e&&e!==0?"":e<1024?e+" B":e<1048576?(e/1024).toFixed(1)+" KB":(e/1048576).toFixed(1)+" MB"}function re(e,t,n,o,s){if(!t.length){e.innerHTML=I("\u{1F4C1}","\u6682\u65E0\u6A21\u578B\u6587\u4EF6");return}const a=ne(t,o,n),i=N(a,"",n,o,s);if(!i){e.innerHTML=I("\u{1F50D}","\u672A\u627E\u5230\u5339\u914D\u7684\u6587\u4EF6");return}e.innerHTML=i}function ce(e,t){if(!e)return;const n=se(t);e.textContent=`\u5171 ${n.total} \u9879 (\u5DF2\u542F\u7528 ${n.enabled}) \xB7 ${Z(n.totalSize)}`}function N(e,t,n,o,s){const a=!!(n||"").trim(),i=Object.keys(e).sort((d,c)=>{const u=!e[d]._e,l=!e[c]._e;if(u&&!l)return-1;if(!u&&l)return 1;const f=e[d]._e,p=e[c]._e;return o==="size"?((p==null?void 0:p.size)||0)-((f==null?void 0:f.size)||0):o==="date"?((p==null?void 0:p.modTime)||0)-((f==null?void 0:f.modTime)||0):d.localeCompare(c)});let r="";return i.forEach(d=>{const c=e[d],u=t?t+"/"+d:d;if(c._e){const l=c._e;if(a&&!l.name.toLowerCase().includes(n.toLowerCase()))return;const f=a?Q(l.name,n):l.name,p=l.modTime?ee(l.modTime):"",g=te(l.name);r+=oe(l,f,g,p)}else{const l=d.startsWith("_"),f=a||!!s[u],p=a?G(c,n.toLowerCase()):!1;r+=ae(d,u,f||a&&p,l),r+=N(c,u,n,o,s),r+="</div>"}}),r}function y(e){!e||(e.classList.add("flash"),setTimeout(()=>e.classList.remove("flash"),400))}function de(e,t){e.querySelectorAll(".fh").forEach(n=>{n.onclick=o=>{o.stopPropagation();const s=n.nextElementSibling,a=n.querySelector(".ar");if(!s)return;const i=s.style.display!=="none";s.style.display=i?"none":"block",a.classList.toggle("open",!i),t._dirOpen[n.dataset.dir]=!i,localStorage.setItem("at_dirs",JSON.stringify(t._dirOpen))}}),e.querySelectorAll(".ck").forEach(n=>{n.onclick=o=>{o.stopPropagation();const s=n.classList.contains("on");n.classList.toggle("on"),n.textContent=n.classList.contains("on")?"\u2713":"";const a=n.closest(".fl");a&&a.classList.add("flash"),setTimeout(()=>a==null?void 0:a.classList.remove("flash"),400);const i=n.dataset.path,r=n.dataset.fullpath||i;bus.emit("entry:toggle",{path:r,relPath:i,enabled:!s})},n.ondblclick=()=>{const o=n.dataset.fullpath||n.dataset.path;o&&bus.emit("model:select",{path:o})}}),e.querySelectorAll(".fl").forEach(n=>{n.oncontextmenu=o=>{var r,d,c;o.preventDefault();const s=((d=(r=n.querySelector(".nm"))==null?void 0:r.textContent)==null?void 0:d.replace(/^\S+\s/,""))||"",a=!((c=n.querySelector(".ck"))!=null&&c.classList.contains("on")),i=n.dataset.fullpath||n.dataset.path;bus.emit("ctx:show",{x:o.clientX,y:o.clientY,path:i,relPath:n.dataset.path,name:s,banned:a})}})}function le(e,t){var s,a,i,r,d,c,u,l,f;const n=p=>e.getElementById(p),o=()=>t._renderTree();(s=n("srch"))==null||s.addEventListener("input",p=>{t._search=p.target.value,o()}),(a=n("sort"))==null||a.addEventListener("change",p=>{t._sort=p.target.value,o()}),(i=n("btn-repo"))==null||i.addEventListener("click",()=>bus.emit("dir:select-repo")),(r=n("btn-dedup"))==null||r.addEventListener("click",()=>bus.emit("entries:dedup")),(d=n("btn-trash"))==null||d.addEventListener("click",()=>bus.emit("recycle:open")),(c=n("btn-pv"))==null||c.addEventListener("click",()=>bus.emit("preview:toggle")),(u=n("btn-ea"))==null||u.addEventListener("click",()=>{y(n("btn-ea")),t._entries.forEach(p=>{p.banned=!1}),o()}),(l=n("btn-da"))==null||l.addEventListener("click",()=>{y(n("btn-da")),t._entries.forEach(p=>{p.banned=!0}),o()}),(f=n("btn-st"))==null||f.addEventListener("click",()=>y(n("btn-st")))}function pe(e,t,n,o,s,a){return window.go.main.App.AddImportLog(e,t,n,o,s,a)}function ue(e){return window.go.main.App.AnalyzeYSMModel(e)}function fe(e){return window.go.main.App.CheckFileExists(e)}function me(e){return window.go.main.App.ClearCustomDir(e)}function he(){return window.go.main.App.ClearImportLogs()}function ge(e){return window.go.main.App.CountLinkedModels(e)}function be(e){return window.go.main.App.CreateDir(e)}function xe(e){return window.go.main.App.DeduplicateCustomDir(e)}function ve(e){return window.go.main.App.DeleteFromRecycle(e)}function we(e){return window.go.main.App.EmptyRecycleBin(e)}function ye(e){return window.go.main.App.GetGlobalCustomDir(e)}function _e(){return window.go.main.App.GetImportLogs()}function j(e,t){return window.go.main.App.GetInstanceStatus(e,t)}function Se(){return window.go.main.App.GetLinkMode()}function ke(){return window.go.main.App.GetMinecraftPath()}function Le(){return window.go.main.App.GetWindowPosition()}function Me(e){return window.go.main.App.HasYSMMod(e)}function Ce(e,t){return window.go.main.App.ImportModelFile(e,t)}function ze(e,t){return window.go.main.App.InstallModelFile(e,t)}function Te(e,t){return window.go.main.App.InstallModelTo(e,t)}function Ee(e,t){return window.go.main.App.InstallModelWithOverlay(e,t)}function Y(e){return window.go.main.App.IsFileBanned(e)}function Ae(e){return window.go.main.App.IsSymlink(e)}function Re(e){return window.go.main.App.ListFileNames(e)}function $e(e){return window.go.main.App.ListRecycleBin(e)}function q(e){return window.go.main.App.ListVersionInstances(e)}function v(){return window.go.main.App.LoadAppConfig()}function Ie(e,t){return window.go.main.App.MoveModelFile(e,t)}function He(e){return window.go.main.App.MoveToRecycle(e)}function Be(e){return window.go.main.App.MoveToRecycleEx(e)}function Pe(e){return window.go.main.App.OpenFolder(e)}function De(e,t){return window.go.main.App.RestoreFromRecycle(e,t)}function A(e,t,n){return window.go.main.App.SaveAppConfig(e,t,n)}function Fe(e,t,n,o){return window.go.main.App.SaveWindowPosition(e,t,n,o)}function Oe(e){return window.go.main.App.ScanCustomModels(e)}function R(e){return window.go.main.App.ScanModelEntries(e)}function $(){return window.go.main.App.SelectDirectory()}function Ge(e){return window.go.main.App.SetLinkMode(e)}function Ne(e){return window.go.main.App.SetRepoRoot(e)}function je(e,t){return window.go.main.App.SyncCustomToRepo(e,t)}function Ye(e,t){return window.go.main.App.SyncModelToggleStatus(e,t)}function U(e){return window.go.main.App.ToggleModelEnable(e)}const T=Object.freeze(Object.defineProperty({__proto__:null,AddImportLog:pe,AnalyzeYSMModel:ue,CheckFileExists:fe,ClearCustomDir:me,ClearImportLogs:he,CountLinkedModels:ge,CreateDir:be,DeduplicateCustomDir:xe,DeleteFromRecycle:ve,EmptyRecycleBin:we,GetGlobalCustomDir:ye,GetImportLogs:_e,GetInstanceStatus:j,GetLinkMode:Se,GetMinecraftPath:ke,GetWindowPosition:Le,HasYSMMod:Me,ImportModelFile:Ce,InstallModelFile:ze,InstallModelTo:Te,InstallModelWithOverlay:Ee,IsFileBanned:Y,IsSymlink:Ae,ListFileNames:Re,ListRecycleBin:$e,ListVersionInstances:q,LoadAppConfig:v,MoveModelFile:Ie,MoveToRecycle:He,MoveToRecycleEx:Be,OpenFolder:Pe,RestoreFromRecycle:De,SaveAppConfig:A,SaveWindowPosition:Fe,ScanCustomModels:Oe,ScanModelEntries:R,SelectDirectory:$,SetLinkMode:Ge,SetRepoRoot:Ne,SyncCustomToRepo:je,SyncModelToggleStatus:Ye,ToggleModelEnable:U},Symbol.toStringTag,{value:"Module"}));async function W(){const e=await v(),t=e.repoRoot||e.RepoRoot||"";if(!t)return null;const n=await R(t);if(!n||!n.length)return null;const o=[];for(const s of n){let a=!1;try{a=await Y(s.Path)}catch{}let i=s.Path;t&&s.Path.startsWith(t)&&(i=s.Path.slice(t.length).replace(/^[/\\]+/,"")),o.push({name:s.Name,path:i,fullPath:s.Path,size:s.Size,modTime:s.ModTime,banned:a})}return{repoRoot:t,entries:o}}function h(){const e=Date.now();return[{name:"steve_skin.ysm",path:"steve_skin.ysm",size:1258291,modTime:e-864e5,banned:!1},{name:"alex_deluxe.ysm",path:"alex/alex_deluxe.ysm",size:2516582,modTime:e-1728e5,banned:!1},{name:"alex_head.ysm",path:"alex/alex_head.ysm",size:524288,modTime:e-1728e5,banned:!1},{name:"dragon_armor.zip",path:"dragon/dragon_armor.zip",size:3984588,modTime:e-36e5,banned:!1},{name:"dragon_wings.ysm",path:"dragon/dragon_wings.ysm",size:2202009,modTime:e-72e5,banned:!1},{name:"neon_sword.ysm",path:"weapons/neon_sword.ysm",size:1572864,modTime:e,banned:!1},{name:"magic_staff.zip",path:"weapons/magic_staff.zip",size:4404019,modTime:e-72e5,banned:!1},{name:"photon_body.ysm",path:"photon/photon_body.ysm",size:2202009,modTime:e-432e5,banned:!1},{name:"old_model.ysm",path:"_disabled/old_model.ysm",size:943718,modTime:e-6048e5,banned:!0},{name:"custom_hat.ysm",path:"custom/custom_hat.ysm",size:838860,modTime:e-2592e5,banned:!1},{name:"steve_2d.ysm",path:"custom/steve_2d.ysm",size:314572,modTime:e-5e5,banned:!1}]}function qe(e){const t=[];return t.push(bus.on("entry:toggle",async({path:n})=>{try{await U(n)}catch{}await H(e)})),t.push(bus.on("dir:select-repo",async()=>{try{const n=await $();if(!n)return;await A(n,"","copy"),e._repoRoot=n,await H(e)}catch{e._entries=h(),e._renderTree()}})),t.push(bus.on("entries:dedup",()=>{bus.emit("toast:show",{msg:"\u{1F517} \u53BB\u91CD\u529F\u80FD\u5F00\u53D1\u4E2D",duration:2e3,type:"info"})})),t.push(bus.on("recycle:open",()=>{bus.emit("toast:show",{msg:"\u{1F5D1}\uFE0F \u56DE\u6536\u7AD9\u529F\u80FD\u5F00\u53D1\u4E2D",duration:2e3,type:"info"})})),t}async function H(e){try{const t=await W();t?(e._repoRoot=t.repoRoot,e._entries=t.entries):e._entries=h()}catch{e._entries=h()}e._renderTree()}class Ue extends HTMLElement{constructor(){super(),this._root=this.attachShadow({mode:"open"}),this._root.adoptedStyleSheets=[new CSSStyleSheet],this._root.adoptedStyleSheets[0].replaceSync(K),this._entries=[],this._search="",this._sort="name",this._dirOpen={},this._repoRoot=""}async connectedCallback(){try{Object.assign(this._dirOpen,JSON.parse(localStorage.getItem("at_dirs")||"{}"))}catch{}this._renderLayout(),le(this._root,this),this._unsubs=qe(this),await this._load(),this._renderTree()}disconnectedCallback(){var t;(t=this._unsubs)==null||t.forEach(n=>n==null?void 0:n())}async _load(){try{const t=await W();t?(this._repoRoot=t.repoRoot,this._entries=t.entries):this._entries=h()}catch{this._entries=h()}}_renderLayout(){this._root.innerHTML=J()+'<div class="list" id="tree"><div class="empty"><div class="big">\u{1F4C1}</div>\u6682\u65E0\u6A21\u578B\u6587\u4EF6</div></div>'+X()}_renderTree(){const t=this._root.getElementById("tree");re(t,this._entries,this._search,this._sort,this._dirOpen),de(t,this),ce(this._root.getElementById("ftr-stat"),this._entries)}}customElements.define("app-tree",Ue);const We=`
:host {
...
`;function Ve(){return`<div class="header">
...
</div>`}function Ke(){return`<div class="footer">
...
${s.join("")}
</div>`}function _(e,t){return`<div class="sec-title">${e} (${t})</div>`}function S(e,t,n){return`<div class="row"><span class="dot" style="background:${e}"></span><span class="rn">${V(t)}</span><span class="sz">${n}</span></div>`}function V(e){return(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Qe(e,t){e.innerHTML="",t.forEach((n,o)=>{const s=document.createElement("div");s.className="vc",s.dataset.idx=o;const a=o===0;s.innerHTML=Xe(n.name,n.synced,n.missing,a),e.appendChild(s);const i=document.createElement("div");i.className="vc-body",i.style.display=a?"":"none",i.innerHTML=Ze(n),e.appendChild(i)})}function Ze(e){let t="";return e.items.synced.length&&(t+=_("\u2705 \u5DF2\u540C\u6B65",e.items.synced.length),e.items.synced.forEach(n=>{t+=S("#a6e3a1",n.name,n.size)})),e.items.missing.length&&(t+=_("\u2B07\uFE0F \u7F3A\u5931",e.items.missing.length),e.items.missing.forEach(n=>{t+=S("#f38ba8",n.name,n.size)})),e.items.extra.length&&(t+=_("\u{1F4E4} \u989D\u5916",e.items.extra.length),e.items.extra.forEach(n=>{t+=S("#f9a826",n.name,n.size)})),t}function et(e){e.querySelectorAll(".vc").forEach(t=>{const n=t.querySelector(".vc-header"),o=t.nextElementSibling;!n||!o||!o.classList.contains("vc-body")||(n.onclick=()=>{const s=n.querySelector(".arrow");o.style.display=o.style.display==="none"?"":"none",s&&s.classList.toggle("open")},n.ondblclick=()=>{const s=n.querySelector(".name"),a=s?s.textContent.replace(/^📦\s*/,""):"";bus.emit("instance:select",{name:a})})})}function tt(e,t){const n=e.getElementById("ver-search");n&&(n.oninput=o=>{const s=o.target.value.toLowerCase().trim();t._search=s,t._renderCards()})}function nt(e){const t=e.getElementById("btn-mc");t&&(t.onclick=()=>bus.emit("dir:select-mc"))}async function st(){bus.emit("loading:start");try{const e=await v(),t=e.mcRoot||e.McRoot||"",n=e.repoRoot||e.RepoRoot||"";if(!t||!n)return null;const o=await R(n),s=new Set;o.forEach(c=>s.add(c.Name.replace(/\.ban$/i,"")));const a=await q(t);if(!a||!a.length)return null;const i=await j(t,n),r={};return(i||[]).forEach(c=>{r[c.Name]=c}),a.map(c=>{const u=r[c.Name]||{},l=u.Missing||[],f=u.Extra||[],p=new Set(l.map(m=>m.replace(/\.ban$/i,""))),g=new Set(f.map(m=>m.replace(/\.ban$/i,""))),w=[];return s.forEach(m=>{!p.has(m)&&!g.has(m)&&w.push(m)}),{name:c.Name,exists:c.Exists,hasYSM:u.HasYSM,synced:w.length,missing:l.length,extra:f.length,items:{synced:w.slice(0,20).map(m=>({name:m,size:""})),missing:l.slice(0,20).map(m=>({name:m,size:""})),extra:f.slice(0,20).map(m=>({name:m,size:""}))}}})}finally{bus.emit("loading:end")}}function B(){return[{name:"\u6211\u7684\u6574\u5408\u5305",synced:3,missing:1,extra:2,items:{synced:[{name:"steve_skin.ysm",size:"1.2 MB"},{name:"alex_deluxe.ysm",size:"2.4 MB"},{name:"neon_sword.ysm",size:"1.5 MB"}],missing:[{name:"dragon_armor.zip",size:"3.8 MB"}],extra:[{name:"custom_hat.ysm",size:"0.8 MB"},{name:"old_hat.ysm",size:"0.3 MB"}]}},{name:"\u5149\u5F71\u6D4B\u8BD5\u5305",synced:1,missing:2,extra:0,items:{synced:[],missing:[],extra:[]}},{name:"\u7A7A\u5C9B\u751F\u5B58",synced:5,missing:0,extra:0,items:{synced:[],missing:[],extra:[]}},{name:"RPG \u5192\u9669",synced:2,missing:3,extra:0,items:{synced:[],missing:[],extra:[]}}]}class ot extends HTMLElement{constructor(){super(),this._root=this.attachShadow({mode:"open"}),this._root.adoptedStyleSheets=[new CSSStyleSheet],this._root.adoptedStyleSheets[0].replaceSync(We),this._instances=[],this._unsubs=[],this._search=""}async connectedCallback(){this._renderLayout(),this._unsubs.push(bus.on("dir:select-mc",async()=>{try{const t=await $();if(!t)return;const n=await v();await A(n.repoRoot||"",t,n.linkMode||"copy")}catch{}await this._reload()})),this._unsubs.push(bus.on("stats:refresh",async()=>{await this._reload()})),await this._reload()}_renderCards(){const t=this._root.getElementById("vg");if(!t)return;const n=this._search,o=n?this._instances.filter(s=>s.name.toLowerCase().includes(n)):this._instances;Qe(t,o),et(this._root)}async _reload(){try{const n=await st();n?this._instances=n:this._instances=B()}catch{this._instances=B()}const t=this._root.getElementById("ver-stat");t&&(t.textContent=`${this._instances.length}\u4E2A\u6574\u5408\u5305`),this._renderCards(),tt(this._root,this),nt(this._root)}disconnectedCallback(){this._unsubs.forEach(t=>t())}_renderLayout(){this._root.innerHTML=Ve()+Je()+Ke()}}customElements.define("app-sidebar",ot);const at="modulepreload",it=function(e){return"/"+e},P={},E=function(t,n,o){if(!n||n.length===0)return t();const s=document.getElementsByTagName("link");return Promise.all(n.map(a=>{if(a=it(a),a in P)return;P[a]=!0;const i=a.endsWith(".css"),r=i?'[rel="stylesheet"]':"";if(!!o)for(let u=s.length-1;u>=0;u--){const l=s[u];if(l.href===a&&(!i||l.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${a}"]${r}`))return;const c=document.createElement("link");if(c.rel=i?"stylesheet":at,i||(c.as="script",c.crossOrigin=""),c.href=a,document.head.appendChild(c),i)return new Promise((u,l)=>{c.addEventListener("load",u),c.addEventListener("error",()=>l(new Error(`Unable to preload CSS for ${a}`)))})})).then(()=>t())},rt=`
:host {
  display: flex; flex-direction: column;
  background: #11111b;
...
`;function ct(){return`<div class="content" id="preview-content">
<h3>\u{1F4CA} \u7EDF\u8BA1</h3>
...
</div>`}function L(e){return(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const dt={repo:6,ver:4,ok:2,tot:4,pending:2};function D(e,t){const n=o=>e.getElementById(o);n("s-repo")&&(n("s-repo").textContent=t.repo),n("s-ver")&&(n("s-ver").textContent=t.ver),n("s-ok")&&(n("s-ok").textContent=t.ok),n("s-tot")&&(n("s-tot").textContent=t.tot),n("s-pending")&&(n("s-pending").textContent=t.pending)}function lt(e){var t;(t=e.getElementById("btn-upload"))==null||t.addEventListener("click",async()=>{bus.emit("stats:upload")})}function pt(e,t,n){n.push(bus.on("stats:updated",o=>{o&&Object.assign(t,o),bus.emit("_preview:needs-update")}))}class ut extends HTMLElement{constructor(){super(),this._root=this.attachShadow({mode:"open"}),this._root.adoptedStyleSheets=[new CSSStyleSheet],this._root.adoptedStyleSheets[0].replaceSync(rt),this._stats={...dt},this._unsubs=[],this._mode="stat"}static get observedAttributes(){return["mode"]}attributeChangedCallback(t,n,o){t==="mode"&&(this._mode=o==="model"?"model":"stat",this._root.isConnected&&this._render())}connectedCallback(){this._mode=this.getAttribute("mode")==="model"?"model":"stat",this._render(),this._mode==="stat"&&(pt(this._root,this._stats,this._unsubs),this._unsubs.push(bus.on("_preview:needs-update",()=>{D(this._root,this._stats)})),this._unsubs.push(bus.on("stats:refresh",()=>{this._loadRealStats()})),this._loadRealStats()),this._mode==="model"&&this._unsubs.push(bus.on("model:select",async({path:t})=>{this._showModelDetail(t)}))}disconnectedCallback(){this._unsubs.forEach(t=>t())}_render(){this._mode==="stat"?(this._root.innerHTML=ct(),lt(this._root)):this._root.innerHTML=k(null)}async _loadRealStats(){bus.emit("loading:start");try{const{LoadAppConfig:t,GetInstanceStatus:n,ScanModelEntries:o}=await E(()=>Promise.resolve().then(()=>T),void 0),s=await t(),a=s.mcRoot||s.McRoot||"",i=s.repoRoot||s.RepoRoot||"",r=await o(i),d=r?r.length:0;let c=0,u=0,l=0;if(a&&i){const f=await n(a,i);f&&(c=f.length,f.forEach(p=>{p.Status==="complete"&&u++,p.Status!=="complete"&&l++}))}this._stats={repo:d,ver:c,ok:u,tot:c,pending:l},D(this._root,this._stats)}catch{}finally{bus.emit("loading:end")}}async _showModelDetail(t){this._root.innerHTML='<div class="content" id="preview-content"><h3>\u{1F4C4} \u6A21\u578B\u4FE1\u606F</h3><div class="stat-row"><span class="label">\u52A0\u8F7D\u4E2D...</span></div></div>';try{const{AnalyzeYSMModel:n}=await E(()=>Promise.resolve().then(()=>T),void 0),o=await n(t);this._root.innerHTML=k(o)}catch(n){this._root.innerHTML=k({hasError:!0,errorMsg:String(n)})}}}customElements.define("app-preview",ut);const ft=`
...
</div>`}function mt(){return'<div class="repo-layout"><app-tree></app-tree><app-preview mode="model"></app-preview></div>'}function ht(){return'<div class="repo-layout"><app-sidebar></app-sidebar><app-preview mode="stat"></app-preview></div>'}function gt(){return`<div style="flex:1;overflow-y:auto">
...
</div>`}function O(e,t){return`<div class="placeholder-box"><div class="big">${e}</div><div>${t}</div><span class="ptag">\u9884\u544A</span></div>`}let M,C,z;class bt extends HTMLElement{constructor(){super(),this._root=this.attachShadow({mode:"open"}),this._root.adoptedStyleSheets=[new CSSStyleSheet],this._root.adoptedStyleSheets[0].replaceSync(ft),this._current="dashboard"}connectedCallback(){this._unsub=bus.on("nav:change",({page:t})=>{this._current=t,bus.emit("nav:changed",{page:t}),this._render()}),bus.on("stats:upload",()=>this._handleUpload()),E(()=>Promise.resolve().then(()=>T),void 0).then(t=>{M=t.LoadAppConfig,C=t.GetInstanceStatus,z=t.SyncCustomToRepo}),this._render()}disconnectedCallback(){this._unsub&&this._unsub()}async _handleUpload(){if(!(!M||!C||!z))try{const t=await M(),n=t.mcRoot||t.McRoot||"",o=t.repoRoot||t.RepoRoot||"";if(!n||!o)return;const s=await C(n,o);if(!s||!s.length)return;let a=0;for(const i of s){if(!i.Extra||i.Extra.length===0)continue;const r=await z(i.CustomDir,o);a+=r}bus.emit("stats:refresh")}catch{}}_render(){let t="";switch(this._current){case"dashboard":t=F();break;case"repository":t=mt();break;case"instances":t=ht();break;case"downloads":t=O("\u2B07\uFE0F","\u4E0B\u8F7D\u4E0E\u66F4\u65B0");break;case"diagnostics":t=O("\u{1F6E0}\uFE0F","\u8BCA\u65AD\u4E0E\u51B2\u7A81\u68C0\u6D4B");break;case"settings":t=gt();break;default:t=F()}this._root.innerHTML=`<div class="page">${t}</div>`}}customElements.define("app-content",bt);
