...
</div>`}function B(t,e){return`<div class="empty"><div class="big">${t}</div>${e}</div>`}function y(t){return(t||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Q(t,e){const s=y(t);if(!e)return s;const o=e.toLowerCase(),n=t.toLowerCase().indexOf(o);if(n===-1)return s;const a=y(t.substring(0,n)),i=y(t.substring(n,n+e.length)),r=y(t.substring(n+e.length));return a+"<mark>"+i+"</mark>"+r}function Z(t){return!t&&t!==0?"":t<1024?t+" B":t<1048576?(t/1024).toFixed(1)+" KB":(t/1048576).toFixed(1)+" MB"}function tt(t){if(!t)return"";const e=new Date(t),s=new Date;return e.toDateString()===s.toDateString()?e.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):(s-e)/864e5<7?["\u65E5","\u4E00","\u4E8C","\u4E09","\u56DB","\u4E94","\u516D"][e.getDay()]+" "+e.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):e.toLocaleDateString([],{month:"short",day:"numeric"})}function et(t){const e=(t.split(".").pop()||"").toLowerCase();return e==="ysm"?"\u{1F48E}":["zip","rar","7z","tar","gz"].includes(e)?"\u{1F4E6}":["png","jpg","jpeg","gif","webp","bmp"].includes(e)?"\u{1F5BC}\uFE0F":["txt","md","json","xml","yml","yaml","cfg","conf","ini"].includes(e)?"\u{1F4C4}":"\u{1F9CA}"}function st(t,e,s){const o=[...t].sort((i,r)=>e==="size"?(r.size||0)-(i.size||0):e==="date"?(r.modTime||0)-(i.modTime||0):i.name.localeCompare(r.name)),n=(s||"").trim().toLowerCase(),a={};return o.forEach(i=>{if(n&&!i.name.toLowerCase().includes(n))return;const r=i.path.replace(/\\/g,"/").split("/");let l=a;for(let c=0;c<r.length-1;c++)!r[c]||(l[r[c]]||(l[r[c]]={}),l=l[r[c]]);l[r[r.length-1]]={_e:i}}),a}function N(t,e){if(!e||!t)return!1;for(const s of Object.keys(t)){const o=t[s];if(o._e){if(o._e.name.toLowerCase().includes(e))return!0}else if(s.toLowerCase().includes(e)||N(o,e))return!0}return!1}function nt(t){const e=t.length,s=t.filter(n=>!n.banned).length,o=t.reduce((n,a)=>n+(a.size||0),0);return{total:e,enabled:s,totalSize:o}}function ot(t,e,s,o){const n=w(t.path),a=w(t.fullPath||t.path),i=t.banned?"":" on",r=t.banned?"":"\u2713";return`<div class="fl${t.banned?" ban":""}" data-path="${n}" data-fullpath="${a}">
<span class="ck${i}" data-path="${n}" data-fullpath="${a}">${r}</span>
<span class="ficon">${s}</span>
<span class="nm">${e}</span>
<span class="sz">${it(t.size)}</span>${o?`<span class="dt">${o}</span>`:""}</div>`}function at(t,e,s,o){const n=o?"\u{1F512}":"\u{1F4C1}",a=o?"#585b70":"#a6adc8",i=o?" locked":"",r=s?"\u25BC":"\u25B6",l=s?" open":"";return`<div class="fh${i}" data-dir="${w(e)}">
<span class="ar${l}">${r}</span>
<span class="nm" style="color:${a}">${n} ${w(t)}</span></div>
<div class="ch" style="display:${s?"block":"none"}">`}function w(t){return(t||"").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function it(t){return!t&&t!==0?"":t<1024?t+" B":t<1048576?(t/1024).toFixed(1)+" KB":(t/1048576).toFixed(1)+" MB"}function rt(t,e,s,o,n){if(!e.length){t.innerHTML=B("\u{1F4C1}","\u6682\u65E0\u6A21\u578B\u6587\u4EF6");return}const a=st(e,o,s),i=q(a,"",s,o,n);if(!i){t.innerHTML=B("\u{1F50D}","\u672A\u627E\u5230\u5339\u914D\u7684\u6587\u4EF6");return}t.innerHTML=i}function ct(t,e){if(!t)return;const s=nt(e);t.textContent=`\u5171 ${s.total} \u9879 (\u5DF2\u542F\u7528 ${s.enabled}) \xB7 ${Z(s.totalSize)}`}function q(t,e,s,o,n){const a=!!(s||"").trim(),i=Object.keys(t).sort((l,c)=>{const d=!t[l]._e,p=!t[c]._e;if(d&&!p)return-1;if(!d&&p)return 1;const f=t[l]._e,u=t[c]._e;return o==="size"?((u==null?void 0:u.size)||0)-((f==null?void 0:f.size)||0):o==="date"?((u==null?void 0:u.modTime)||0)-((f==null?void 0:f.modTime)||0):l.localeCompare(c)});let r="";return i.forEach(l=>{const c=t[l],d=e?e+"/"+l:l;if(c._e){const p=c._e;if(a&&!p.name.toLowerCase().includes(s.toLowerCase()))return;const f=a?Q(p.name,s):p.name,u=p.modTime?tt(p.modTime):"",m=et(p.name);r+=ot(p,f,m,u)}else{const p=l.startsWith("_"),f=a||!!n[d],u=a?N(c,s.toLowerCase()):!1;r+=at(l,d,f||a&&u,p),r+=q(c,d,s,o,n),r+="</div>"}}),r}function P(t){!t||(t.classList.add("flash"),setTimeout(()=>t.classList.remove("flash"),400))}function lt(t,e){t.querySelectorAll(".fh").forEach(s=>{s.onclick=o=>{o.stopPropagation();const n=s.nextElementSibling,a=s.querySelector(".ar");if(!n)return;const i=n.style.display!=="none";n.style.display=i?"none":"block",a.classList.toggle("open",!i),e._dirOpen[s.dataset.dir]=!i,localStorage.setItem("at_dirs",JSON.stringify(e._dirOpen))}}),t.querySelectorAll(".ck").forEach(s=>{s.onclick=o=>{o.stopPropagation();const n=s.classList.contains("on");s.classList.toggle("on"),s.textContent=s.classList.contains("on")?"\u2713":"";const a=s.closest(".fl");a&&a.classList.add("flash"),setTimeout(()=>a==null?void 0:a.classList.remove("flash"),400);const i=s.dataset.path,r=s.dataset.fullpath||i;bus.emit("entry:toggle",{path:r,relPath:i,enabled:!n})}}),t.querySelectorAll(".fh").forEach(s=>{s.oncontextmenu=o=>{o.preventDefault(),o.stopPropagation(),bus.emit("ctx:show",{x:o.clientX,y:o.clientY,type:"dir",dir:s.dataset.dir})}}),t.querySelectorAll(".fl").forEach(s=>{s.oncontextmenu=o=>{var i;o.preventDefault(),o.stopPropagation();const n=!((i=s.querySelector(".ck"))!=null&&i.classList.contains("on")),a=s.dataset.fullpath||s.dataset.path;bus.emit("ctx:show",{x:o.clientX,y:o.clientY,type:"file",path:a,banned:n})}})}function dt(t,e){var n,a,i,r,l,c,d,p,f;const s=u=>t.getElementById(u),o=()=>e._renderTree();(n=s("srch"))==null||n.addEventListener("input",u=>{e._search=u.target.value,o()}),(a=s("sort"))==null||a.addEventListener("change",u=>{e._sort=u.target.value,o()}),(i=s("btn-repo"))==null||i.addEventListener("click",()=>bus.emit("dir:select-repo")),(r=s("btn-dedup"))==null||r.addEventListener("click",()=>bus.emit("entries:dedup")),(l=s("btn-trash"))==null||l.addEventListener("click",()=>bus.emit("recycle:open")),(c=s("btn-pv"))==null||c.addEventListener("click",()=>bus.emit("preview:toggle")),(d=s("btn-ea"))==null||d.addEventListener("click",()=>{P(s("btn-ea")),e._entries.forEach(u=>{u.banned=!1}),o()}),(p=s("btn-da"))==null||p.addEventListener("click",()=>{P(s("btn-da")),e._entries.forEach(u=>{u.banned=!0}),o()}),(f=s("btn-st"))==null||f.addEventListener("click",()=>{bus.emit("sync:toggle-status")})}function R(t,e,s,o,n,a){return window.go.main.App.AddImportLog(t,e,s,o,n,a)}function pt(t){return window.go.main.App.AnalyzeYSMModel(t)}function ut(t){return window.go.main.App.CheckFileExists(t)}function ft(t){return window.go.main.App.ClearCustomDir(t)}function gt(){return window.go.main.App.ClearImportLogs()}function mt(t){return window.go.main.App.CountLinkedModels(t)}function ht(t){return window.go.main.App.CreateDir(t)}function bt(t){return window.go.main.App.DeduplicateCustomDir(t)}function xt(t){return window.go.main.App.DeleteFromRecycle(t)}function vt(t){return window.go.main.App.EmptyRecycleBin(t)}function yt(t){return window.go.main.App.GetGlobalCustomDir(t)}function wt(){return window.go.main.App.GetImportLogs()}function V(t,e){return window.go.main.App.GetInstanceStatus(t,e)}function _t(){return window.go.main.App.GetLinkMode()}function kt(){return window.go.main.App.GetMinecraftPath()}function St(){return window.go.main.App.GetWindowPosition()}function Lt(t){return window.go.main.App.HasYSMMod(t)}function Et(t,e){return window.go.main.App.ImportModelFile(t,e)}function Mt(t,e){return window.go.main.App.InstallModelFile(t,e)}function Tt(t,e){return window.go.main.App.InstallModelTo(t,e)}function zt(t,e){return window.go.main.App.InstallModelWithOverlay(t,e)}function Y(t){return window.go.main.App.IsFileBanned(t)}function Ct(t){return window.go.main.App.IsSymlink(t)}function Rt(t){return window.go.main.App.ListFileNames(t)}function $t(t){return window.go.main.App.ListRecycleBin(t)}function A(t){return window.go.main.App.ListVersionInstances(t)}function v(){return window.go.main.App.LoadAppConfig()}function At(t,e){return window.go.main.App.MoveModelFile(t,e)}function It(t){return window.go.main.App.MoveToRecycle(t)}function Dt(t){return window.go.main.App.MoveToRecycleEx(t)}function Ht(t){return window.go.main.App.OpenFolder(t)}function Bt(t,e){return window.go.main.App.RestoreFromRecycle(t,e)}function I(t,e,s){return window.go.main.App.SaveAppConfig(t,e,s)}function Pt(t,e,s,o){return window.go.main.App.SaveWindowPosition(t,e,s,o)}function Ot(t){return window.go.main.App.ScanCustomModels(t)}function D(t){return window.go.main.App.ScanModelEntries(t)}function H(){return window.go.main.App.SelectDirectory()}function Ft(t){return window.go.main.App.SetLinkMode(t)}function jt(t){return window.go.main.App.SetRepoRoot(t)}function Gt(t,e){return window.go.main.App.SyncCustomToRepo(t,e)}function Nt(t,e){return window.go.main.App.SyncModelToggleStatus(t,e)}function U(t){return window.go.main.App.ToggleModelEnable(t)}const h=Object.freeze(Object.defineProperty({__proto__:null,AddImportLog:R,AnalyzeYSMModel:pt,CheckFileExists:ut,ClearCustomDir:ft,ClearImportLogs:gt,CountLinkedModels:mt,CreateDir:ht,DeduplicateCustomDir:bt,DeleteFromRecycle:xt,EmptyRecycleBin:vt,GetGlobalCustomDir:yt,GetImportLogs:wt,GetInstanceStatus:V,GetLinkMode:_t,GetMinecraftPath:kt,GetWindowPosition:St,HasYSMMod:Lt,ImportModelFile:Et,InstallModelFile:Mt,InstallModelTo:Tt,InstallModelWithOverlay:zt,IsFileBanned:Y,IsSymlink:Ct,ListFileNames:Rt,ListRecycleBin:$t,ListVersionInstances:A,LoadAppConfig:v,MoveModelFile:At,MoveToRecycle:It,MoveToRecycleEx:Dt,OpenFolder:Ht,RestoreFromRecycle:Bt,SaveAppConfig:I,SaveWindowPosition:Pt,ScanCustomModels:Ot,ScanModelEntries:D,SelectDirectory:H,SetLinkMode:Ft,SetRepoRoot:jt,SyncCustomToRepo:Gt,SyncModelToggleStatus:Nt,ToggleModelEnable:U},Symbol.toStringTag,{value:"Module"}));async function qt(){const t=await v(),e=t.repoRoot||t.RepoRoot||"";if(!e)return null;const s=await D(e);if(!s||!s.length)return null;const o=[];for(const n of s){let a=!1;try{a=await Y(n.Path)}catch{}let i=n.Path;e&&n.Path.startsWith(e)&&(i=n.Path.slice(e.length).replace(/^[/\\]+/,"")),o.push({name:n.Name,path:i,fullPath:n.Path,size:n.Size,modTime:n.ModTime,banned:a})}return{repoRoot:e,entries:o}}function $(){const t=Date.now();return[{name:"steve_skin.ysm",path:"steve_skin.ysm",size:1258291,modTime:t-864e5,banned:!1},{name:"alex_deluxe.ysm",path:"alex/alex_deluxe.ysm",size:2516582,modTime:t-1728e5,banned:!1},{name:"alex_head.ysm",path:"alex/alex_head.ysm",size:524288,modTime:t-1728e5,banned:!1},{name:"dragon_armor.zip",path:"dragon/dragon_armor.zip",size:3984588,modTime:t-36e5,banned:!1},{name:"dragon_wings.ysm",path:"dragon/dragon_wings.ysm",size:2202009,modTime:t-72e5,banned:!1},{name:"neon_sword.ysm",path:"weapons/neon_sword.ysm",size:1572864,modTime:t,banned:!1},{name:"magic_staff.zip",path:"weapons/magic_staff.zip",size:4404019,modTime:t-72e5,banned:!1},{name:"photon_body.ysm",path:"photon/photon_body.ysm",size:2202009,modTime:t-432e5,banned:!1},{name:"old_model.ysm",path:"_disabled/old_model.ysm",size:943718,modTime:t-6048e5,banned:!0},{name:"custom_hat.ysm",path:"custom/custom_hat.ysm",size:838860,modTime:t-2592e5,banned:!1},{name:"steve_2d.ysm",path:"custom/steve_2d.ysm",size:314572,modTime:t-5e5,banned:!1}]}const Vt="modulepreload",Yt=function(t){return"/"+t},O={},b=function(e,s,o){if(!s||s.length===0)return e();const n=document.getElementsByTagName("link");return Promise.all(s.map(a=>{if(a=Yt(a),a in O)return;O[a]=!0;const i=a.endsWith(".css"),r=i?'[rel="stylesheet"]':"";if(!!o)for(let d=n.length-1;d>=0;d--){const p=n[d];if(p.href===a&&(!i||p.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${a}"]${r}`))return;const c=document.createElement("link");if(c.rel=i?"stylesheet":Vt,i||(c.as="script",c.crossOrigin=""),c.href=a,document.head.appendChild(c),i)return new Promise((d,p)=>{c.addEventListener("load",d),c.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${a}`)))})})).then(()=>e())};function Ut(t){const e=[];return e.push(bus.on("entry:toggle",async({path:s})=>{try{await U(s)}catch{}await reload(t),bus.emit("stats:refresh")})),e.push(bus.on("dir:select-repo",async()=>{try{const s=await H();if(!s)return;await I(s,"","copy"),t._repoRoot=s,await reload(t),bus.emit("stats:refresh")}catch{t._entries=$(),t._renderTree()}})),e.push(bus.on("entries:dedup",()=>{bus.emit("toast:show",{msg:"\u{1F517} \u53BB\u91CD\u529F\u80FD\u5F00\u53D1\u4E2D",duration:2e3,type:"info"})})),e.push(bus.on("recycle:open",()=>{bus.emit("toast:show",{msg:"\u{1F5D1}\uFE0F \u56DE\u6536\u7AD9\u529F\u80FD\u5F00\u53D1\u4E2D",duration:2e3,type:"info"})})),e.push(bus.on("batch:enable",({dir:s})=>{batchToggle(t,s,!0)})),e.push(bus.on("batch:disable",({dir:s})=>{batchToggle(t,s,!1)})),e.push(bus.on("sync:toggle-status",async()=>{try{const s=await v(),o=s.repoRoot||s.RepoRoot||"",n=s.mcRoot||s.McRoot||"";if(!o||!n){bus.emit("toast:show",{msg:"\u8BF7\u5148\u914D\u7F6E\u6E38\u620F\u76EE\u5F55\u548C\u4ED3\u5E93\u76EE\u5F55",duration:3e3,type:"warn"});return}const a=await A(n);if(!a||!a.length){bus.emit("toast:show",{msg:"\u6CA1\u6709\u627E\u5230\u6574\u5408\u5305",duration:2e3,type:"info"});return}let i=0,r=0;const l=[];for(const c of a)if(!!c.Exists)try{const{SyncModelToggleStatus:d}=await b(()=>Promise.resolve().then(()=>h),void 0),p=await d(c.CustomDir,o),f=p&&(p.r0||p[0])||0,u=p&&(p.r1||p[1])||0;(f>0||u>0)&&(i+=f,r+=u)}catch(d){l.push(`${c.Name}: ${String(d)}`)}await R("sync-status","\u540C\u6B65\u72B6\u6001 ("+a.filter(c=>c.Exists).length+" \u4E2A\u6574\u5408\u5305)",o,0,l.length?"failed":"success","\u7981\u7528 "+i+" \u542F\u7528 "+r+(l.length?" | \u9519\u8BEF: "+l.join("; "):"")),bus.emit("toast:show",{msg:`\u2705 \u540C\u6B65\u5B8C\u6210\uFF1A\u7981\u7528 ${i} \u9879\uFF0C\u542F\u7528 ${r} \u9879`,duration:3e3,type:"success"}),await reload(t),bus.emit("stats:refresh"),bus.emit("logs:refresh")}catch(s){await R("sync-status","\u540C\u6B65\u5931\u8D25",repoRoot||"",0,"failed",String(s)),bus.emit("toast:show",{msg:`\u540C\u6B65\u5931\u8D25: ${String(s)}`,duration:8e3,type:"error"}),bus.emit("logs:refresh")}})),e}class Wt extends HTMLElement{constructor(){super(),this._root=this.attachShadow({mode:"open"}),this._root.adoptedStyleSheets=[new CSSStyleSheet],this._root.adoptedStyleSheets[0].replaceSync(K),this._entries=[],this._search="",this._sort="name",this._dirOpen={},this._repoRoot=""}async connectedCallback(){try{Object.assign(this._dirOpen,JSON.parse(localStorage.getItem("at_dirs")||"{}"))}catch{}this._renderLayout(),dt(this._root,this),this._unsubs=Ut(this),await this._load(),this._renderTree()}disconnectedCallback(){var e;(e=this._unsubs)==null||e.forEach(s=>s==null?void 0:s())}async _load(){try{const e=await qt();e?(this._repoRoot=e.repoRoot,this._entries=e.entries):this._entries=$()}catch{this._entries=$()}}_renderLayout(){this._root.innerHTML=X()+'<div class="list" id="tree"><div class="empty"><div class="big">\u{1F4C1}</div>\u6682\u65E0\u6A21\u578B\u6587\u4EF6</div></div>'+J()}_renderTree(){const e=this._root.getElementById("tree");rt(e,this._entries,this._search,this._sort,this._dirOpen),lt(e,this),ct(this._root.getElementById("ftr-stat"),this._entries)}}customElements.define("app-tree",Wt);const Kt=`
:host {
