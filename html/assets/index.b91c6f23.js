...
</div>`}function M(e,t){return`<div class="empty"><div class="big">${e}</div>${t}</div>`}function v(e){return(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Y(e,t){const n=v(e);if(!t)return n;const a=t.toLowerCase(),s=e.toLowerCase().indexOf(a);if(s===-1)return n;const o=v(e.substring(0,s)),i=v(e.substring(s,s+t.length)),r=v(e.substring(s+t.length));return o+"<mark>"+i+"</mark>"+r}function U(e){return!e&&e!==0?"":e<1024?e+" B":e<1048576?(e/1024).toFixed(1)+" KB":(e/1048576).toFixed(1)+" MB"}function K(e){if(!e)return"";const t=new Date(e),n=new Date;return t.toDateString()===n.toDateString()?t.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):(n-t)/864e5<7?["\u65E5","\u4E00","\u4E8C","\u4E09","\u56DB","\u4E94","\u516D"][t.getDay()]+" "+t.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):t.toLocaleDateString([],{month:"short",day:"numeric"})}function G(e){const t=(e.split(".").pop()||"").toLowerCase();return t==="ysm"?"\u{1F48E}":["zip","rar","7z","tar","gz"].includes(t)?"\u{1F4E6}":["png","jpg","jpeg","gif","webp","bmp"].includes(t)?"\u{1F5BC}\uFE0F":["txt","md","json","xml","yml","yaml","cfg","conf","ini"].includes(t)?"\u{1F4C4}":"\u{1F9CA}"}function V(e,t,n){const a=[...e].sort((i,r)=>t==="size"?(r.size||0)-(i.size||0):t==="date"?(r.modTime||0)-(i.modTime||0):i.name.localeCompare(r.name)),s=(n||"").trim().toLowerCase(),o={};return a.forEach(i=>{if(s&&!i.name.toLowerCase().includes(s))return;const r=i.path.replace(/\\/g,"/").split("/");let d=o;for(let c=0;c<r.length-1;c++)!r[c]||(d[r[c]]||(d[r[c]]={}),d=d[r[c]]);d[r[r.length-1]]={_e:i}}),o}function A(e,t){if(!t||!e)return!1;for(const n of Object.keys(e)){const a=e[n];if(a._e){if(a._e.name.toLowerCase().includes(t))return!0}else if(n.toLowerCase().includes(t)||A(a,t))return!0}return!1}function J(e){const t=e.length,n=e.filter(s=>!s.banned).length,a=e.reduce((s,o)=>s+(o.size||0),0);return{total:t,enabled:n,totalSize:a}}function W(e,t,n,a){const s=y(e.path),o=y(e.fullPath||e.path),i=e.banned?"":" on",r=e.banned?"":"\u2713";return`<div class="fl${e.banned?" ban":""}" data-path="${s}" data-fullpath="${o}">
<span class="ck${i}" data-path="${s}" data-fullpath="${o}">${r}</span>
<span class="ficon">${n}</span>
<span class="nm">${t}</span>
<span class="sz">${Q(e.size)}</span>${a?`<span class="dt">${a}</span>`:""}</div>`}function X(e,t,n,a){const s=a?"\u{1F512}":"\u{1F4C1}",o=a?"#585b70":"#a6adc8",i=a?" locked":"",r=n?"\u25BC":"\u25B6",d=n?" open":"";return`<div class="fh${i}" data-dir="${y(t)}">
<span class="ar${d}">${r}</span>
<span class="nm" style="color:${o}">${s} ${y(e)}</span></div>
<div class="ch" style="display:${n?"block":"none"}">`}function y(e){return(e||"").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function Q(e){return!e&&e!==0?"":e<1024?e+" B":e<1048576?(e/1024).toFixed(1)+" KB":(e/1048576).toFixed(1)+" MB"}function Z(e,t,n,a,s){if(!t.length){e.innerHTML=M("\u{1F4C1}","\u6682\u65E0\u6A21\u578B\u6587\u4EF6");return}const o=V(t,a,n),i=R(o,"",n,a,s);if(!i){e.innerHTML=M("\u{1F50D}","\u672A\u627E\u5230\u5339\u914D\u7684\u6587\u4EF6");return}e.innerHTML=i}function ee(e,t){if(!e)return;const n=J(t);e.textContent=`\u5171 ${n.total} \u9879 (\u5DF2\u542F\u7528 ${n.enabled}) \xB7 ${U(n.totalSize)}`}function R(e,t,n,a,s){const o=!!(n||"").trim(),i=Object.keys(e).sort((d,c)=>{const h=!e[d]._e,f=!e[c]._e;if(h&&!f)return-1;if(!h&&f)return 1;const u=e[d]._e,l=e[c]._e;return a==="size"?((l==null?void 0:l.size)||0)-((u==null?void 0:u.size)||0):a==="date"?((l==null?void 0:l.modTime)||0)-((u==null?void 0:u.modTime)||0):d.localeCompare(c)});let r="";return i.forEach(d=>{const c=e[d],h=t?t+"/"+d:d;if(c._e){const f=c._e;if(o&&!f.name.toLowerCase().includes(n.toLowerCase()))return;const u=o?Y(f.name,n):f.name,l=f.modTime?K(f.modTime):"",g=G(f.name);r+=W(f,u,g,l)}else{const f=d.startsWith("_"),u=o||!!s[h],l=o?A(c,n.toLowerCase()):!1;r+=X(d,h,u||o&&l,f),r+=R(c,h,n,a,s),r+="</div>"}}),r}function k(e){!e||(e.classList.add("flash"),setTimeout(()=>e.classList.remove("flash"),400))}function te(e,t){e.querySelectorAll(".fh").forEach(n=>{n.onclick=a=>{a.stopPropagation();const s=n.nextElementSibling,o=n.querySelector(".ar");if(!s)return;const i=s.style.display!=="none";s.style.display=i?"none":"block",o.classList.toggle("open",!i),t._dirOpen[n.dataset.dir]=!i,localStorage.setItem("at_dirs",JSON.stringify(t._dirOpen))}}),e.querySelectorAll(".ck").forEach(n=>{n.onclick=a=>{a.stopPropagation();const s=n.classList.contains("on");n.classList.toggle("on"),n.textContent=n.classList.contains("on")?"\u2713":"";const o=n.closest(".fl");o&&o.classList.add("flash"),setTimeout(()=>o==null?void 0:o.classList.remove("flash"),400);const i=n.dataset.path,r=n.dataset.fullpath||i;bus.emit("entry:toggle",{path:r,relPath:i,enabled:!s})}}),e.querySelectorAll(".fl").forEach(n=>{n.oncontextmenu=a=>{var r,d,c;a.preventDefault();const s=((d=(r=n.querySelector(".nm"))==null?void 0:r.textContent)==null?void 0:d.replace(/^\S+\s/,""))||"",o=!((c=n.querySelector(".ck"))!=null&&c.classList.contains("on")),i=n.dataset.fullpath||n.dataset.path;bus.emit("ctx:show",{x:a.clientX,y:a.clientY,path:i,relPath:n.dataset.path,name:s,banned:o})}})}function ne(e,t){var s,o,i,r,d,c,h,f,u;const n=l=>e.getElementById(l),a=()=>t._renderTree();(s=n("srch"))==null||s.addEventListener("input",l=>{t._search=l.target.value,a()}),(o=n("sort"))==null||o.addEventListener("change",l=>{t._sort=l.target.value,a()}),(i=n("btn-repo"))==null||i.addEventListener("click",()=>bus.emit("dir:select-repo")),(r=n("btn-dedup"))==null||r.addEventListener("click",()=>bus.emit("entries:dedup")),(d=n("btn-trash"))==null||d.addEventListener("click",()=>bus.emit("recycle:open")),(c=n("btn-pv"))==null||c.addEventListener("click",()=>bus.emit("preview:toggle")),(h=n("btn-ea"))==null||h.addEventListener("click",()=>{k(n("btn-ea")),t._entries.forEach(l=>{l.banned=!1}),a()}),(f=n("btn-da"))==null||f.addEventListener("click",()=>{k(n("btn-da")),t._entries.forEach(l=>{l.banned=!0}),a()}),(u=n("btn-st"))==null||u.addEventListener("click",()=>k(n("btn-st")))}function se(e,t){return window.go.main.App.GetInstanceStatus(e,t)}function ae(e){return window.go.main.App.IsFileBanned(e)}function oe(e){return window.go.main.App.ListVersionInstances(e)}function T(){return window.go.main.App.LoadAppConfig()}function P(e,t,n){return window.go.main.App.SaveAppConfig(e,t,n)}function L(e){return window.go.main.App.ScanModelEntries(e)}function O(){return window.go.main.App.SelectDirectory()}function ie(e){return window.go.main.App.ToggleModelEnable(e)}async function D(){const e=await T(),t=e.repoRoot||e.RepoRoot||"";if(!t)return null;const n=await L(t);if(!n||!n.length)return null;const a=[];for(const s of n){let o=!1;try{o=await ae(s.Path)}catch{}let i=s.Path;t&&s.Path.startsWith(t)&&(i=s.Path.slice(t.length).replace(/^[/\\]+/,"")),a.push({name:s.Name,path:i,fullPath:s.Path,size:s.Size,modTime:s.ModTime,banned:o})}return{repoRoot:t,entries:a}}function b(){const e=Date.now();return[{name:"steve_skin.ysm",path:"steve_skin.ysm",size:1258291,modTime:e-864e5,banned:!1},{name:"alex_deluxe.ysm",path:"alex/alex_deluxe.ysm",size:2516582,modTime:e-1728e5,banned:!1},{name:"alex_head.ysm",path:"alex/alex_head.ysm",size:524288,modTime:e-1728e5,banned:!1},{name:"dragon_armor.zip",path:"dragon/dragon_armor.zip",size:3984588,modTime:e-36e5,banned:!1},{name:"dragon_wings.ysm",path:"dragon/dragon_wings.ysm",size:2202009,modTime:e-72e5,banned:!1},{name:"neon_sword.ysm",path:"weapons/neon_sword.ysm",size:1572864,modTime:e,banned:!1},{name:"magic_staff.zip",path:"weapons/magic_staff.zip",size:4404019,modTime:e-72e5,banned:!1},{name:"photon_body.ysm",path:"photon/photon_body.ysm",size:2202009,modTime:e-432e5,banned:!1},{name:"old_model.ysm",path:"_disabled/old_model.ysm",size:943718,modTime:e-6048e5,banned:!0},{name:"custom_hat.ysm",path:"custom/custom_hat.ysm",size:838860,modTime:e-2592e5,banned:!1},{name:"steve_2d.ysm",path:"custom/steve_2d.ysm",size:314572,modTime:e-5e5,banned:!1}]}function re(e){const t=[];return t.push(bus.on("entry:toggle",async({path:n})=>{try{await ie(n)}catch{}await C(e)})),t.push(bus.on("dir:select-repo",async()=>{try{const n=await O();if(!n)return;await P(n,"","copy"),e._repoRoot=n,await C(e)}catch{e._entries=b(),e._renderTree()}})),t.push(bus.on("entries:dedup",()=>{bus.emit("toast:show",{msg:"\u{1F517} \u53BB\u91CD\u529F\u80FD\u5F00\u53D1\u4E2D",duration:2e3,type:"info"})})),t.push(bus.on("recycle:open",()=>{bus.emit("toast:show",{msg:"\u{1F5D1}\uFE0F \u56DE\u6536\u7AD9\u529F\u80FD\u5F00\u53D1\u4E2D",duration:2e3,type:"info"})})),t}async function C(e){try{const t=await D();t?(e._repoRoot=t.repoRoot,e._entries=t.entries):e._entries=b()}catch{e._entries=b()}e._renderTree()}class ce extends HTMLElement{constructor(){super(),this._root=this.attachShadow({mode:"open"}),this._root.adoptedStyleSheets=[new CSSStyleSheet],this._root.adoptedStyleSheets[0].replaceSync(N),this._entries=[],this._search="",this._sort="name",this._dirOpen={},this._repoRoot=""}async connectedCallback(){try{Object.assign(this._dirOpen,JSON.parse(localStorage.getItem("at_dirs")||"{}"))}catch{}this._renderLayout(),ne(this._root,this),this._unsubs=re(this),await this._load(),this._renderTree()}disconnectedCallback(){var t;(t=this._unsubs)==null||t.forEach(n=>n==null?void 0:n())}async _load(){try{const t=await D();t?(this._repoRoot=t.repoRoot,this._entries=t.entries):this._entries=b()}catch{this._entries=b()}}_renderLayout(){this._root.innerHTML=j()+'<div class="list" id="tree"><div class="empty"><div class="big">\u{1F4C1}</div>\u6682\u65E0\u6A21\u578B\u6587\u4EF6</div></div>'+q()}_renderTree(){const t=this._root.getElementById("tree");Z(t,this._entries,this._search,this._sort,this._dirOpen),te(t,this),ee(this._root.getElementById("ftr-stat"),this._entries)}}customElements.define("app-tree",ce);const de=`
:host {
...
.instance-detail { flex:1; display:flex; overflow-y:auto; padding:16px; }
...
</div>`}function Me(){return'<div class="repo-layout"><app-tree></app-tree></div>'}function Ce(){return'<div class="repo-layout"><app-sidebar></app-sidebar><div class="instance-detail" id="instance-detail"><div class="placeholder-box"><div class="big">\u{1F4E6}</div><div>\u9009\u62E9\u4E00\u4E2A\u6574\u5408\u5305\u67E5\u770B\u8BE6\u60C5</div></div></div></div>'}function $e(){return`<div style="flex:1;overflow-y:auto">
