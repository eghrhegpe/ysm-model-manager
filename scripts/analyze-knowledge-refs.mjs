#!/usr/bin/env node
/**
 * analyze-knowledge-refs.mjs — 知识卡引用深度与耦合分析（一次性诊断工具）。
 *
 ...
 *
 * 用法：
 *   node scripts/analyze-knowledge-refs.mjs           # 全量分析 + 写报告
...
function render(cards, data) {
  ...
  L.push('# 知识卡引用深度与耦合分析');
  L.push('');
  L.push(`> **自动生成**：\`node scripts/analyze-knowledge-refs.mjs\` 产出，禁止手改。`);
